...
public class EnvSitCConcIndirizzi extends it.webred.rulengine.brick.loadDwh.load.concessioni.v1.EnvSitCConcIndirizzi {



	public EnvSitCConcIndirizzi(String nomeTabellaOrigine, String provenienza, String...  nomeCampoChiave) {
