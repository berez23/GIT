...
public class CosapStandardFiles <T extends CosapTipoRecordEnv<TestataStandardFileBean>> extends ImportStandardFiles<T> {
	
	public CosapStandardFiles(T env) {
		super(env);
