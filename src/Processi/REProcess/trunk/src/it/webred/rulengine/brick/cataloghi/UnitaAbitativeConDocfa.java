 ...
 */
public class UnitaAbitativeConDocfa extends Command implements Rule
{
	private static final Logger log = Logger.getLogger(UnitaAbitativeConDocfa.class.getName());

	/**
	 * @param bc
	 */
	public UnitaAbitativeConDocfa(BeanCommand bc){
		super(bc);
	}
	
	public UnitaAbitativeConDocfa(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
	...
	{
		final String NOME_TABELLA = "CAT_UNITA_ABITATIVE_DOCFA";
		final String NOME_SINONIMO = "CAT_UNITA_ABITATIVE_DOCFA";
		final String NOME_INDICE = "CAT_UNITA_ABITATIVE_DOCFA_SDX";
		final String CODIFICA = "UAD"; //Unita abitative docfa
		...
		try
		{
			...
			if (esisteTab){
				...
				"from (select foglio, part, sub from  " + nomeSchemaDiogene + ".docfa_report) " +
...
//				}				
				 ...
				 * STA02-U.I. RES. COINVOLTE DA DOCFA
				 * è fissa perché non esiste fino a 
				 * quando da SITI non si è inserito un catalogo  
				 */
				log.debug("STA02-U.I. RES. COINVOLTE DA DOCFA: Tabella " + NOME_TABELLA + " inesistente");
