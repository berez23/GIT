...
import it.webred.rulengine.brick.loadDwh.load.acqua.tributaria.AcquaTipoRecordFiles;
...
public class  ImportAcquaTributariaRule extends Command implements Rule    {

	private static final org.apache.log4j.Logger log = Logger.getLogger(ImportAcquaTributariaRule.class.getName());

		
	
	public ImportAcquaTributariaRule(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
