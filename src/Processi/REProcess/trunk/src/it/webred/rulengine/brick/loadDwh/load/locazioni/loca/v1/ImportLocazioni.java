package it.webred.rulengine.brick.loadDwh.load.locazioni.loca.v1;
...
public class ImportLocazioni<T extends  Env<?>> extends ConcreteImport<T> {
	...
	@Override
	public it.webred.rulengine.brick.loadDwh.load.locazioni.loca.v1.Env<LocazioniEnv> getEnvSpec(EnvImport ei) {
		return new it.webred.rulengine.brick.loadDwh.load.locazioni.loca.v1.Env<LocazioniEnv>((LocazioniEnv)ei);
	}
