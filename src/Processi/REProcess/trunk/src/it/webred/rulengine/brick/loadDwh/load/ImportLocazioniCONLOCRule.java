...
import it.webred.rulengine.brick.loadDwh.load.locazioni.conloc.LocazioniFiles;
...
public class ImportLocazioniCONLOCRule extends Command implements Rule {
	private static Logger log = Logger.getLogger(ImportLocazioniCONLOCRule.class.getName());

	public ImportLocazioniCONLOCRule(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
	...
	public CommandAck run(Context ctx) throws CommandException {
		...
		try {
			...
			//se nn ci sono file da elaborare RejectAck
