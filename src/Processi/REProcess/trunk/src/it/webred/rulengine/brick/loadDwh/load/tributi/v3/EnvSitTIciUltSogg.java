...
public class EnvSitTIciUltSogg extends EnvInsertDwh {
	...
	public EnvSitTIciUltSogg(String nomeTabellaOrigine, String provenienza, String[] nomeCampoChiave) {
	...
	public ArrayList<RigaToInsert> getRigheSpec(ResultSet rs) throws Exception {
		...
		params.put("ID_ORIG_OGG_ICI", rs.getString("ID_ORIG_OGG_ICI"));
		params.put("ID_ORIG_SOGG", rs.getString("ID_ORIG_SOGG"));
		params.put("TIT_SOGG", rs.getString("TIT_SOGG"));
		params.put("FLAG_CNT", rs.getString("FLAG_CNT"));
		params.put("FLAG_DICH", rs.getString("FLAG_DICH"));
		params.put("FLAG_CTT", rs.getString("FLAG_CTT"));		
