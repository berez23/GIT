...
public class EnvSitRuoloTarsuImm extends EnvInsertDwh {
	...
	public EnvSitRuoloTarsuImm(String nomeTabellaOrigine, String provenienza, String[] nomeCampoChiave) {
	...
	public ArrayList<RigaToInsert> getRigheSpec(ResultSet rs) throws Exception {
		...
		params.put("TARIFFA", getBD(rs.getString("TARIFFA")));
		params.put("RIDUZIONE", getBD(rs.getString("RIDUZIONE")));
