...
public class ImportF24<T extends  Env<?>> extends ConcreteImport<T> {
	...
	@Override
	public it.webred.rulengine.brick.loadDwh.load.F24.t2014.tasi.Env<F24Env> getEnvSpec(EnvImport ei) {
		return new it.webred.rulengine.brick.loadDwh.load.F24.t2014.tasi.Env<F24Env>((F24Env)ei);
	}
