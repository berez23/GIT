...
public class SitTIciVersamenti extends TabellaDwhMultiProv implements IdExtFromSequence {
	
	
	private Relazione idExtSoggIci = new Relazione(SitTIciSogg.class, new ChiaveEsterna());	
	...
	public Relazione getIdExtSoggIci() {
		return idExtSoggIci;
	}

	public void setIdExtSoggIci(ChiaveEsterna idExtSoggIci)
	{
		Relazione r = new Relazione(SitTIciSogg.class, idExtSoggIci);
		this.idExtSoggIci = r;
	}
	...
	public DataDwh getDatPag() {
		return datPag;
	}

	public void setDatPag(DataDwh datPag) {
		this.datPag = datPag;
	}
	...
	public String getValueForCtrHash() {		
		return (String)this.idExtSoggIci.getRelazione().getValore() +
		this.idOrigSoggU +
		this.codFisc +
		this.partIva +
		this.cogDenom +
