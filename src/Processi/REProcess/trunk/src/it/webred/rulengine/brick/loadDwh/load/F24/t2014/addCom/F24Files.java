package it.webred.rulengine.brick.loadDwh.load.F24.t2014.addCom;
...
public class F24Files<T extends F24Env> extends ImportFilesFlat<T> {
	...
	public void tracciaFornitura(String file, String cartellaDati, String line)
			throws RulEngineException {
		/*
		 * Nella fornitura F24 della addizionale comunale abbiamo AAAAMM come riferimento 
		 * temporale per cui, per coerenza di codice java, impostiamo il giorno 01 del mese indicato
		 */
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
		String data = line.substring(2,8) + "01";
		try {
