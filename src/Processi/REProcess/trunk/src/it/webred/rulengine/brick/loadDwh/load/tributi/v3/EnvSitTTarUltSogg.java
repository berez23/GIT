...
public class EnvSitTTarUltSogg extends EnvInsertDwh {
	...
	public EnvSitTTarUltSogg(String nomeTabellaOrigine, String provenienza, String[] nomeCampoChiave) {
	...
	public ArrayList<RigaToInsert> getRigheSpec(ResultSet rs) throws Exception {
		...
		params.put("FLAG_CONTRIBUENTE", rs.getString("FLAG_CONTRIBUENTE"));
		params.put("FLAG_DICHIARANTE", rs.getString("FLAG_DICHIARANTE"));
