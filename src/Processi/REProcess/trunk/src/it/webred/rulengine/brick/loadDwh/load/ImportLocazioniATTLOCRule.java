...
import it.webred.rulengine.brick.loadDwh.load.locazioni.attloc.LocazioniFiles;
...
public class ImportLocazioniATTLOCRule extends Command implements Rule {
	private static Logger log = Logger.getLogger(ImportLocazioniATTLOCRule.class.getName());

	public ImportLocazioniATTLOCRule(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
