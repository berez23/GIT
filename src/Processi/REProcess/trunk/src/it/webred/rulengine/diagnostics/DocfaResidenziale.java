...
public class DocfaResidenziale extends ElaboraDiagnosticsNonStandard {

	public DocfaResidenziale(Connection connPar, Context ctxPar,
			List<RRuleParamIn> paramsPar) {
		super(connPar, ctxPar, paramsPar);
		log = Logger.getLogger(DocfaResidenziale.class.getName());		
	}
