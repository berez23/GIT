package it.webred.rulengine.brick.loadDwh.load.demografia.vie;
...
public class DemogVieEnv extends EnvImport {

	public DemogVieEnv(String connectionName, Context ctx)		throws RulEngineException {
