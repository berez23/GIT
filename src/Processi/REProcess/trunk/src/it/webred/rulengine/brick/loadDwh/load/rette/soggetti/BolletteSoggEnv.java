...
public class BolletteSoggEnv extends EnvImport {

	public String RE_RTT_SOGG_BOLLETTE_1_0 = getProperty("table1_0.name");
	public String RE_RTT_SOGG_BOLLETTE_IDX = getProperty("table1_0.idx");
	...
	public BolletteSoggEnv(String connectionName, Context ctx) throws RulEngineException {
