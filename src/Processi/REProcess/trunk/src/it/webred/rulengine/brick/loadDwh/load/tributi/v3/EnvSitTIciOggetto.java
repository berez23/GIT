...
public class EnvSitTIciOggetto extends EnvInsertDwh {
	...
	public ArrayList<RigaToInsert> getRigheSpec(ResultSet rs) throws Exception {
		...
		// tolto sulla versione 3 
		params.put("PAR_CTS", null);
	...
	public String getSqlUpdateFlagElaborato() {
		return "UPDATE " + getNomeTabellaOrigine() + " SET RE_FLAG_ELABORATO='1' WHERE ID_ORIG_OGG_ICI=? AND DT_EXP_DATO=? AND RE_FLAG_ELABORATO='0'";
	}
