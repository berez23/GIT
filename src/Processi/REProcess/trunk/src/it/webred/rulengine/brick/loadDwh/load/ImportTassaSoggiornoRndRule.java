...
import it.webred.rulengine.brick.loadDwh.load.tassasoggiorno.rnd.TSRndFiles;
...
public class ImportTassaSoggiornoRndRule extends Command implements Rule {
	private static Logger log = Logger.getLogger(ImportTassaSoggiornoRndRule.class.getName());

	public ImportTassaSoggiornoRndRule(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
	...
	public CommandAck run(Context ctx) throws CommandException {
		...
		try {
			TSRndEnv env = new TSRndEnv((String)ctx.get("connessione"), ctx);
			TSRndFiles<TSRndEnv> redd = new TSRndFiles<TSRndEnv>(env);
