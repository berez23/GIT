...
public class SitTTarSogg extends TabellaDwhMultiProv {
	...
	private Relazione idExtViaRes = new Relazione(SitTTarVia.class, new ChiaveEsterna());
	...
	{
		Relazione r = new Relazione(SitTTarVia.class, idExtViaRes);
		this.idExtViaRes = r;
	}
