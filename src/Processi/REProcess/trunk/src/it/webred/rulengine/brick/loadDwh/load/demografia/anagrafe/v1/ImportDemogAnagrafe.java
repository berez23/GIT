...
public class ImportDemogAnagrafe<T extends  Env<?>> extends ConcreteImport<T>  {

	public ImportDemogAnagrafe() {
		super();
		// TODO Auto-generated constructor stub
	}

	@Override
	public it.webred.rulengine.brick.loadDwh.load.demografia.anagrafe.v1.Env<DemogAnagrafeEnv> getEnvSpec(EnvImport ei) {
		return new it.webred.rulengine.brick.loadDwh.load.demografia.anagrafe.v1.Env<DemogAnagrafeEnv>((DemogAnagrafeEnv)ei);
	}
