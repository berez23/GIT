...
import it.webred.rulengine.brick.loadDwh.load.acqua.spoleto.AcquaSpoletoConcreteImportEnv;
import it.webred.rulengine.brick.loadDwh.load.acqua.spoleto.AcquaSpoletoEnv;
import it.webred.rulengine.brick.loadDwh.load.acqua.spoleto.v1.EnvReAcqua;

public class Env<T extends AcquaSpoletoEnv> extends AcquaSpoletoConcreteImportEnv<T> {
