...
public class EnvSitCPersona extends EnvInsertDwh {
	...
	LinkedHashMap< String, Object> params = new LinkedHashMap<String, Object>();
		...
		// non si chiede il titolo solo per la persona 
		// ma soltanto in relazione alla concessione , dunque il titolo sulla tabella SI_C_PERSONA non è usato
		...
		params.put("DATA_INI_RES",rs.getTimestamp("data_inizio_residenza")  );
