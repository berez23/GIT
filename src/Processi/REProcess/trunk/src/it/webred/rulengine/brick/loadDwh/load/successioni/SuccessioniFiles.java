...
public class SuccessioniFiles<T extends SuccessioniEnv> extends ImportFilesFlat<T> {

	public SuccessioniFiles(T env) {
		super(env);
	...
	public void tracciaFornitura(String file, String cartellaDati, String line)
		...
		String sData = file.substring(13, 17);
		String sMeseGiornoIni = "0101";
		String sMeseGiornoFin = "1231";
		if(!file.startsWith("ACCSUC")){
