...
import it.webred.rulengine.brick.loadDwh.load.locazioni.accloc.LocazioniEnv;
import it.webred.rulengine.brick.loadDwh.load.locazioni.accloc.LocazioniFiles;
...
public class ImportLocazioniACCLOCRule extends Command implements Rule {
	private static Logger log = Logger.getLogger(ImportLocazioniACCLOCRule.class.getName());

	public ImportLocazioniACCLOCRule(BeanCommand bc, Properties jrulecfg) {
		super(bc, jrulecfg);
