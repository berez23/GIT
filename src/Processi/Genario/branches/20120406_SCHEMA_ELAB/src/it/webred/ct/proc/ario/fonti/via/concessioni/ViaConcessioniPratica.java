package it.webred.ct.proc.ario.fonti.via.concessioni;
...
import it.webred.ct.proc.ario.fonti.via.tributi.ViaTributiOggettoIci;
import it.webred.ct.proc.ario.normalizzazione.NormalizzaTotali;

public class ViaConcessioniPratica extends DatoDwh implements Via{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(ViaConcessioniPratica.class.getName());
		
	
	public ViaConcessioniPratica(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_CONCESSIONI_PRATICA");
				
		if (processID != null && !processID.equals("")){
			sqlVia = sqlVia + " WHERE CI.PROCESSID =?";
		}
	...
	public String getTable() {
		...
		String tabella = "SIT_C_CONC_INDIRIZZI";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Via Concessioni Pratica="+e.getMessage());
			Exception ea = new Exception("Errore:Save Via Concessioni Pratica:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Via Concessioni Pratica="+e.getMessage());
			Exception ea = new Exception("Errore:Update Via Concessioni Pratica:"+e.getMessage());
			throw ea;
		}
	...
	public boolean codiceVia(String codEnte, HashParametriConfBean paramConfBean) throws Exception{
		...
		try{
			...
			log.warn("Errore:Recupero Codice Originario Vie="+e.getMessage());
