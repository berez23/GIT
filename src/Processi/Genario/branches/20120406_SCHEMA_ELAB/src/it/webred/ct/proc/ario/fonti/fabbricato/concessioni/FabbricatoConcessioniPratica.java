package it.webred.ct.proc.ario.fonti.fabbricato.concessioni;
...
public class FabbricatoConcessioniPratica extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoConcessioniPratica.class.getName());
	
	
	public FabbricatoConcessioniPratica(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_CONCESSIONI");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Fabbricato Enel="+e.getMessage());
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, String updateFabbricatoTotale, String searchFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Fabbricato Concessioni="+e.getMessage());
			Exception ea = new Exception("Errore:Update Fabbricato Concessioni:"+e.getMessage());
			throw ea;
		}
