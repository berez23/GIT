...
public class CaricatoreArioFactory {
	 ...
	 * @return
	 */
	public void Execute(String codEnte, Connection connForRead,Connection connForInsert, ArrayList<String> listaFonti, HashParametriConfBean paramConfBean) throws RulEngineException
	{		
