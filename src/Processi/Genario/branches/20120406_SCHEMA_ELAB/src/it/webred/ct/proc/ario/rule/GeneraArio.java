...
public class GeneraArio extends Command implements Rule {
	...
	public CommandAck run(Context ctx) throws CommandException {
		...
		try {
			...
			log.debug("#########################################################################################################################");
			Connection connForInsert = RulesConnection.getConnection("ELAB_" + ctx.getBelfiore());
			...
			caf.Execute(codEnte, conn,connForInsert, listaFontiNew, paramConfBean);
						
			DbUtils.close(connForInsert);
			resultdate = new Date( System.currentTimeMillis());
			...
			log.debug("#########################################################################################################################");						       	
			connForLongResultset = RulesConnection.getConnection("ELAB_" + ctx.getBelfiore());
			connForInsert = RulesConnection.getConnection("ELAB_" + ctx.getBelfiore());
			...
			vie.setConnection(connForInsert);
			...
			sog.setConnection(connForInsert);
			...
			og.setConnection(connForInsert);
			...
			fa.setConnection(connForInsert);
