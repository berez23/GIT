package it.webred.ct.proc.ario.fonti.via.licenzeCommerciali;
...
public class ViaLicenzeCommerciali extends DatoDwh implements Via{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(ViaLicenzeCommerciali.class.getName());
		
	
	public ViaLicenzeCommerciali(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_LIC_COMM");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Via Licenze Commerciali="+e.getMessage());
			Exception ea = new Exception("Errore:Save Via Licenze Commerciali:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Via Licenze Commerciali="+e.getMessage());
			Exception ea = new Exception("Errore:Update Via Licenze Commerciali:"+e.getMessage());
			throw ea;
		}
