...
public class ViaTributiOggettoTarsu extends DatoDwh implements Via{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(ViaTributiOggettoTarsu.class.getName());
		
	
	public ViaTributiOggettoTarsu(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_TRIBUTI_TARSU");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Via Tributi TARSU="+e.getMessage());
			Exception ea = new Exception("Errore:Save Via Tributi TARSU:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Via Tributi TARSU="+e.getMessage());
			Exception ea = new Exception("Errore:Update Via Tributi TARSU:"+e.getMessage());
			throw ea;
		}
