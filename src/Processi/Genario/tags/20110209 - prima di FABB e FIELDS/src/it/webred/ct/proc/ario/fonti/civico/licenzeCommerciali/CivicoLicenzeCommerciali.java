package it.webred.ct.proc.ario.fonti.civico.licenzeCommerciali;
...
public class CivicoLicenzeCommerciali extends DatoDwh implements Civici{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(CivicoLicenzeCommerciali.class.getName());
	
	
	public CivicoLicenzeCommerciali(){
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIVICO_LIC_COMM");
				
		if (processID != null && !processID.equals("")){
			sqlCivico = sqlCivico + " WHERE lcc.PROCESSID =?";
		}
	...
	public String getTable() {
		...
		String tabella = "SIT_LICENZE_COMMERCIO";
		//String tabella = "SIT_LICENZE_COMMERCIO_VIE";	
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Civico Licenze Commerciali="+e.getMessage());
			Exception ea = new Exception("Errore:Save Civico Licenze Commerciali:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Licenze Commerciali="+e.getMessage());
			Exception ea = new Exception("Errore:Update Civico Licenze Commerciali:"+e.getMessage());
			throw ea;
		}
	...
	public boolean codiceCivico(String codEnte, HashParametriConfBean paramConfBean) throws Exception{
		...
		try{
			...
			log.warn("Errore:Recupero Codice Originario Civico="+e.getMessage());
