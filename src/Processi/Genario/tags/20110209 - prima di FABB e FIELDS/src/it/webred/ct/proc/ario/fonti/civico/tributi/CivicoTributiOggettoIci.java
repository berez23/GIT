package it.webred.ct.proc.ario.fonti.civico.tributi;
...
import it.webred.ct.proc.ario.fonti.civico.demografia.CivicoDemografia;
import it.webred.ct.proc.ario.normalizzazione.NormalizzaTotali;

public class CivicoTributiOggettoIci extends DatoDwh implements Civici{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(CivicoTributiOggettoIci.class.getName());
	
	
	public CivicoTributiOggettoIci(){
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIVICO_TRIBUTI_ICI");
				
		if (processID != null && !processID.equals("")){
			sqlCivico = sqlCivico + " WHERE iciv.PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Civico Tributi Ici="+e.getMessage());
			Exception ea = new Exception("Errore:Save Civico Tributi Ici:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Tributi Ici="+e.getMessage());
			Exception ea = new Exception("Errore:Update Civico Tributi Ici:"+e.getMessage());
			throw ea;
		}
