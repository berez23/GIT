...
public class CivicoConcessioniPratica extends DatoDwh implements Civici{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(CivicoConcessioniPratica.class.getName());
	
	
	public CivicoConcessioniPratica(){
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIVICO_CONCESSIONI_PRATICA");
				
		if (processID != null && !processID.equals("")){
			sqlCivico = sqlCivico + " WHERE PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			Exception ea = new Exception("Errore:Save Civico Concessioni Pratica:"+e.getMessage());
			throw ea;
		}
