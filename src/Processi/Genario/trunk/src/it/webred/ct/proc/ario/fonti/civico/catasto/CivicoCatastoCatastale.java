...
public class CivicoCatastoCatastale extends DatoDwh implements Civici{
	
	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoCatastoCatastale.class.getName());
	
	
	public CivicoCatastoCatastale(){
	...
	public String getSql(String processID) {
		...
		String sqlCivicoCatCatastale = this.getProperty("SQL_CIVICO_CATASTO2");
						
		return sqlCivicoCatCatastale;
	...
	public String getTable() {
		...
		String tabella = "LOAD_CAT_UIU_IND";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			String idOrigVia = rs.getString("ID_DWH");//stessa chiave
			String numCiv1 = rs.getString("CIV1");
			String numCiv2 = rs.getString("CIV2");
			String numCiv3 = rs.getString("CIV3");
			...
			log.warn("Errore:Save Civico Catasto Catastale="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Catasto Catastale:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Catasto Catastale="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico Catasto Catastale:"+e.getMessage());
			throw ea;
		}
