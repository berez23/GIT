...
public class SoggettoF24AnnulContrib extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	
	protected static final Logger log = Logger.getLogger(SoggettoF24AnnulContrib.class.getName());
	
	
	public SoggettoF24AnnulContrib(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoVersContrib = this.getProperty("SQL_SOGG_F24_ANNUL_CONTRIB");
	...
	public String getTable() {
		...
		String tabella = "SIT_T_F24_ANNULLAMENTO";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			sst.setField13(rs.getString("FIELD16"));
			sst.setField14(rs.getString("FIELD17"));
			sst.setField15(rs.getString("FIELD18"));
			...
			log.warn("Errore:Save Soggetto Annullamento="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Annullamento:"+e.getMessage());
			throw ea;
		}
