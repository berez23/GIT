package it.webred.ct.proc.ario.fonti.oggetto.compravendite;
...
import it.webred.ct.proc.ario.fonti.oggetto.docfa.OggettoDocfa;
import it.webred.ct.proc.ario.normalizzazione.NormalizzaTotali;

public class OggettoCompravendite extends DatoDwh implements Oggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(OggettoCompravendite.class.getName());
	
	
	public OggettoCompravendite(){
	...
	public String getSql(String processID) {
		...
		String sqlOggettoCatasto1 = this.getProperty("SQL_OGG_COMPRAVENDITE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Oggetto Compravendite="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Oggetto Compravendite:"+e.getMessage());
			throw ea;
		}
