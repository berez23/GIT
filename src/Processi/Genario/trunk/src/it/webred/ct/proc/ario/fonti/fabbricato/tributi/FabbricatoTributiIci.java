...
public class FabbricatoTributiIci extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoTributiIci.class.getName());
	
	
	public FabbricatoTributiIci(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_TRIBUTI_ICI");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			sft.setField30(rs.getString("FIELD30"));
			sft.setField31(rs.getString("FIELD31"));
			...
			log.warn("Errore:Save Fabbricato Tributi Ici="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Tributi Ici:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, String updateFabbricatoTotale, String searchFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Fabbricato Ici= "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Fabbricato Ici:"+e.getMessage());
			throw ea;
		}
