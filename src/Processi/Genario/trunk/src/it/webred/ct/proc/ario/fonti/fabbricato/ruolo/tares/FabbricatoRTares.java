package it.webred.ct.proc.ario.fonti.fabbricato.ruolo.tares;
...
public class FabbricatoRTares extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoRTares.class.getName());
	private String desc = "Fabbricato Ruolo Tares";
	
	public FabbricatoRTares(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_R_TARES");
				
		if (processID != null && !processID.equals("")){
			sqlFabbricato = sqlFabbricato + " AND PROCESSID =?";
		}
	...
	public String getTable() {
		...
		String tabella = "SIT_RUOLO_TARES_IMM";		
		return tabella;
	}
