package it.webred.ct.proc.ario.fonti.civico.ruolo.tares;
...
public class CivResContrib extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivResContrib.class.getName());
	private String desc = "Civico di residenza Contribuente Ruolo Tares";
	
	public CivResContrib(){
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIV_R_TARES_CONTRIB");
