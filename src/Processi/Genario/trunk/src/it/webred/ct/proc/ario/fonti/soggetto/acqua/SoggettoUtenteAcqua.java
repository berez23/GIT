package it.webred.ct.proc.ario.fonti.soggetto.acqua;
...
public class SoggettoUtenteAcqua extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoUtenteAcqua.class.getName());
	
	
	public SoggettoUtenteAcqua(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoMulte = this.getProperty("SQL_SOGG_ACQUA_UTENTE");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoMulte = sqlSoggettoMulte + " WHERE PROCESSID =?";
		}
			
		return sqlSoggettoMulte;
	...
	public String getTable() {
		...
		String tabella = "SIT_ACQUA_UTENTE";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Soggetto Utente Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Utente Acqua:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Soggetto Utente Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Utente Acqua:"+e.getMessage());
			throw ea;
		}
