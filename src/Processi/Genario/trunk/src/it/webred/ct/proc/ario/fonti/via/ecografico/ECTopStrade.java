package it.webred.ct.proc.ario.fonti.via.ecografico;
...
public class ECTopStrade extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ECTopStrade.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_ECOGRAFICO_STRADE");
