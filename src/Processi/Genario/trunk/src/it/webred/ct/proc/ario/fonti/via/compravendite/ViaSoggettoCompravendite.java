...
public class ViaSoggettoCompravendite extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaSoggettoCompravendite.class.getName());
	
	
	public ViaSoggettoCompravendite(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_COMPRAV_SOGG");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Soggetti Compraventite"+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Soggetti Compraventite:"+e.getMessage());
			throw ea;
		}
