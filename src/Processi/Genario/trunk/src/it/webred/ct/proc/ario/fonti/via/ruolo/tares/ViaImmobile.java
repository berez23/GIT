package it.webred.ct.proc.ario.fonti.via.ruolo.tares;
...
public class ViaImmobile extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaImmobile.class.getName());
	private String desc = "Via Immobile Ruolo Tarsu";
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_R_TARES_IMM");
