package it.webred.ct.proc.ario.fonti.civico.cened;
...
public class CivicoCened extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoCened.class.getName());
	...
	public String getSql(String processID) {
		String sqlCivicoLocazioniI = this.getProperty("SQL_CIV_CENED");
...
//				sct.setDataFineVal(dataFineVal);
			...
			log.warn("Errore:Save Civico Cened: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Cened: "+e.getMessage());
			throw ea;
		}
...
//				sct.setDataFineVal(dataFineVal);
			...
			log.warn("Errore:Update Civico Cened: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico Cened: "+e.getMessage());
			throw ea;
		}
