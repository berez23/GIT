...
public class CivicoLocazioniB extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoLocazioniB.class.getName());
	
	
	public CivicoLocazioniB(){
	...
	public String getSql(String processID) {
		...
		String sqlCivicoLocazioniB = this.getProperty("SQL_CIV_LOCAZIONI2");
						
		return sqlCivicoLocazioniB;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			String strInd = "AAAA ";
			String civico =	(rs.getString("CIVICO")!=null?rs.getString("CIVICO"):"-");
			...
			log.warn("Errore:Save Civico LocazioniB="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico LocazioniB:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico LocazioniB="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico LocazioniB:"+e.getMessage());
			throw ea;
		}
