...
public class SoggettoVers extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	
	protected static final Logger log = Logger.getLogger(SoggettoVers.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoVersContrib = this.getProperty("SQL_SOGG_ICI_DM_VERS");
	...
	public String getTable() {
		...
		String tabella = "SIT_T_ICI_DM_VERS";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			Exception ea = new Exception("Errore:Save Soggetto Contribuente ICI DM:"+e.getMessage());
			throw ea;
		}
