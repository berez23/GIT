package it.webred.ct.proc.ario.fonti.soggetto.fornitureElettriche;
...
public class SoggettoEnel extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	
	protected static final Logger log = Logger.getLogger(SoggettoEnel.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoFornitureElettriche = this.getProperty("SQL_SOGG_FORNITURE_ELETTRICHE");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoFornitureElettriche = sqlSoggettoFornitureElettriche + " WHERE PROCESSID =?";
		}
			
		return sqlSoggettoFornitureElettriche;
	...
	public String getTable() {
		...
		String tabella = "SIT_ENEL_UTENTE";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Enel="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Enel:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Enel="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Enel:"+e.getMessage());
			throw ea;
		}
