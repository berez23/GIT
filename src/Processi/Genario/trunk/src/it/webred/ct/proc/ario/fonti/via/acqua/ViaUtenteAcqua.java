package it.webred.ct.proc.ario.fonti.via.acqua;
...
public class ViaUtenteAcqua extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaUtenteAcqua.class.getName());
	
	
	public ViaUtenteAcqua(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_ACQUA_UTENTE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Utente Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Utente Acqua:"+e.getMessage());
			throw ea;
		}
