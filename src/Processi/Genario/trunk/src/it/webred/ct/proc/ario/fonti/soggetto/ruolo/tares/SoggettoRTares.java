package it.webred.ct.proc.ario.fonti.soggetto.ruolo.tares;
...
public class SoggettoRTares extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	
	protected static final Logger log = Logger.getLogger(SoggettoRTares.class.getName());
	
	
	public SoggettoRTares(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoVersContrib = this.getProperty("SQL_SOGG_R_TARES");
	...
	public String getTable() {
		...
		String tabella = "SIT_RUOLO_TARES";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{	
			...
			log.warn("Errore:Save Soggetto Ruoli Tares="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Ruoli Tares:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Contribuente Versamenti ICI DM="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Contribuente Versamenti ICI DM:"+e.getMessage());
			throw ea;
		}
