package it.webred.ct.proc.ario.fonti.via.portaleServizi;
...
public class ViaPortaleServizi extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaPortaleServizi.class.getName());
	
	
	public ViaPortaleServizi(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_PORTALESERVIZI");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via PortaleServizi="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via PortaleServizi:"+e.getMessage());
			throw ea;
		}
