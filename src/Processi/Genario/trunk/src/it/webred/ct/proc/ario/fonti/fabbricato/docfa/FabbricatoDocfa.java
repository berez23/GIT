package it.webred.ct.proc.ario.fonti.fabbricato.docfa;
...
public class FabbricatoDocfa extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoDocfa.class.getName());
	
	
	public FabbricatoDocfa(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_DOCFA");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs,String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Fabbricato Docfa="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Docfa:"+e.getMessage());
			throw ea;
		}
