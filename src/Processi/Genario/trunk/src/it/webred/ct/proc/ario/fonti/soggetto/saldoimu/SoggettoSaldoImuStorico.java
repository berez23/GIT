package it.webred.ct.proc.ario.fonti.soggetto.saldoimu;
...
public class SoggettoSaldoImuStorico extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	
	protected static final Logger log = Logger.getLogger(SoggettoSaldoImuStorico.class.getName());
	
	
	public SoggettoSaldoImuStorico(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoVersContrib = this.getProperty("SQL_SOGG_SALDO_IMU_STORICO");
	...
	public String getTable() {
		...
		String tabella = "SALDO_IMU_STORICO";		
		return tabella;
	}
