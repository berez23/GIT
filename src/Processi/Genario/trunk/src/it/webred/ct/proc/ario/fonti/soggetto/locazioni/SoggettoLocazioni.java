package it.webred.ct.proc.ario.fonti.soggetto.locazioni;
...
public class SoggettoLocazioni extends DatoDwh implements Soggetto{

	
	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoLocazioni.class.getName());
	
	
	public SoggettoLocazioni(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggetto = this.getProperty("SQL_SOGG_LOCAZIONI");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Locazioni="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Locazioni:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Locazioni="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Locazioni:"+e.getMessage());
			throw ea;
		}
