package it.webred.ct.proc.ario.fonti.soggetto.ruolo.tarsu;
...
public class SoggettoRTarsu extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	private String desc = "Ruoli Tarsu";
	
	protected static final Logger log = Logger.getLogger(SoggettoRTarsu.class.getName());
	
	
	public SoggettoRTarsu(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoVersContrib = this.getProperty("SQL_SOGG_R_TARSU");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{	
			...
			log.warn("Errore:Save Soggetto "+desc+":"+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto "+desc+":"+e.getMessage());
			throw ea;
		}
