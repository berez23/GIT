package it.webred.ct.proc.ario.fonti.civico.fornitureElettriche;
...
public class CivicoEnel extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoEnel.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlCivicoFornitureElettriche = this.getProperty("SQL_CIV_FORNITURE_ELETTRICHE");
				
		if (processID != null && !processID.equals("")){
			sqlCivicoFornitureElettriche = sqlCivicoFornitureElettriche + " WHERE utenza.PROCESSID =?";			
		}
			
		return sqlCivicoFornitureElettriche;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Civico Enel="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Enel:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Enel="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico Enel:"+e.getMessage());
			throw ea;
		}
	...
	public String getQuerySQLSaveProcessId() throws Exception {
		...
		String query = getProperty("SQL_INSERT_PID_CIV");
