...
public class CivicoLocazioniI extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoLocazioniI.class.getName());
	
	
	public CivicoLocazioniI(){
	...
	public String getSql(String processID) {
		...
		String sqlCivicoLocazioniI = this.getProperty("SQL_CIV_LOCAZIONI3");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Civico LocazioniI="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico LocazioniI:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico LocazioniI="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico LocazioniI:"+e.getMessage());
			throw ea;
		}
