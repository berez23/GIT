package it.webred.ct.proc.ario.fonti.civico.demanio;
...
public class CivicoBene extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoBene.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIV_DEMANIO");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{									
			...
			log.warn("Errore:Save Civico Bene Demanio="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Bene Demanio:"+e.getMessage());
			throw ea;
		}
