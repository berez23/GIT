package it.webred.ct.proc.ario.fonti.oggetto.fornitureElettriche;
...
public class OggettoEnel extends DatoDwh implements Oggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(OggettoEnel.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlOggettoFornitureElettriche = this.getProperty("SQL_OGG_FORNITURE_ELETTRICHE");
				
		if (processID != null && !processID.equals("")){
			sqlOggettoFornitureElettriche = sqlOggettoFornitureElettriche + " WHERE PROCESSID =?";
			//sqlOggettoFornitureElettriche = sqlOggettoFornitureElettriche + " AND PROCESSID =?";
		}
			
		return sqlOggettoFornitureElettriche;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Oggetto Enel="+e.getMessage(), e);
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, String updateOggettoTotale, String searchOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Oggetto Enel="+e.getMessage(), e);
