package it.webred.ct.proc.ario.fonti.oggetto.concessioni;
...
public class OggettoConcessioniPratica extends DatoDwh implements Oggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(OggettoConcessioniPratica.class.getName());
	
	
	public OggettoConcessioniPratica(){
	...
	public String getSql(String processID) {
		...
		String sqlOggetto = this.getProperty("SQL_OGG_CONCESSIONI");
	...
	public String getTable() {
		...
		String tabella = "SIT_C_CONCESSIONI_CATASTO";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Oggetto Concessioni Pratica="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Oggetto Concessioni Pratica:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, String updateOggettoTotale, String searchOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Oggetto Concessioni Pratica="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Oggetto Concessioni Pratica:"+e.getMessage());
			throw ea;
		}
