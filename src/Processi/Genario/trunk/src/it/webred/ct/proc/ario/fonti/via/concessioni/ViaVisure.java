...
public class ViaVisure extends DatoDwh implements Via{

	private Properties props = null;
	
	protected static final Logger log = Logger.getLogger(ViaVisure.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_CONCEDI_VISURE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.error("Errore:Save Via Concessioni Visure ="+e.getMessage(),e);
			Exception ea = new Exception("Errore:Save Via Concessioni Visure:"+e.getMessage());
			throw ea;
		}
