...
public class ViaLocazioniI extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaLocazioniI.class.getName());
	
	
	public ViaLocazioniI(){
	...
	public String getSql(String processID) {
		...
		String sqlViaLocazioniI = this.getProperty("SQL_VIA_LOCAZIONI3");
						
		return sqlViaLocazioniI;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Locazioni I="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Locazioni I:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Via Locazioni I="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Via Locazioni I:"+e.getMessage());
			throw ea;
		}
