...
public class ViaCatastoCatastale extends DatoDwh implements Via{

	private Properties props = null;

	protected static final Logger log = Logger.getLogger(ViaCatastoCatastale.class.getName());
	
	
	public ViaCatastoCatastale(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_CATASTO2");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Via Catatsto Catastale="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Catatsto Catastale:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Via Catatsto Catastale="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Via Catatsto Catastale:"+e.getMessage());
			throw ea;
		}
