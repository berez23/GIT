...
public class ViaUtenzeAcqua extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaUtenzeAcqua.class.getName());
	
	
	public ViaUtenzeAcqua(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_ACQUA_UTENZE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Utenze Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Utenze Acqua:"+e.getMessage());
			throw ea;
		}
