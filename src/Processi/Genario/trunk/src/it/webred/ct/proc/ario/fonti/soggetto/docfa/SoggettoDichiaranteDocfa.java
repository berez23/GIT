package it.webred.ct.proc.ario.fonti.soggetto.docfa;
...
public class SoggettoDichiaranteDocfa extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoDichiaranteDocfa.class.getName());
	
	
	public SoggettoDichiaranteDocfa(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggetto = this.getProperty("SQL_SOGG_DOCFA_DICHIARANTE");
	...
	public String getTable() {
		...
		String tabella = "DOCFA_DICHIARANTI";			
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Docfa Dichiarante ="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Docfa Dichiarante:"+e.getMessage());
			throw ea;
		}
