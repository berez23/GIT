...
public class SoggettoVisure extends DatoDwh implements Soggetto{

	private Properties props = null;	
	
	protected static final Logger log = Logger.getLogger(SoggettoVisure.class.getName());
	
	public SoggettoVisure(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoConcessioni = this.getProperty("SQL_SOGG_CONCEDI_VISURE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Concessioni Visure="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Concessioni Visure:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Concessioni Visure="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Concessioni Visure:"+e.getMessage());
			throw ea;
		}
