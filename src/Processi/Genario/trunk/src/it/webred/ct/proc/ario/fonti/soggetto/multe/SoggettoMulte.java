package it.webred.ct.proc.ario.fonti.soggetto.multe;
...
public class SoggettoMulte extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoMulte.class.getName());
	
	
	public SoggettoMulte(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoMulte = this.getProperty("SQL_SOGG_MULTE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Soggetto Multe="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Multe:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Soggetto Multe="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Multe:"+e.getMessage());
			throw ea;
		}
