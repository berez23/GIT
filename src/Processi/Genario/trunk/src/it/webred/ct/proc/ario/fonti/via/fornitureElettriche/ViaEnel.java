package it.webred.ct.proc.ario.fonti.via.fornitureElettriche;
...
public class ViaEnel extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaEnel.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlViaFornitureElettriche = this.getProperty("SQL_VIA_FORNITURE_ELETTRICHE");
				
		if (processID != null && !processID.equals("")){
			sqlViaFornitureElettriche = sqlViaFornitureElettriche + " WHERE utenza.PROCESSID =?";
		}
			
		return sqlViaFornitureElettriche;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Via Enel="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Enel:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Via Enel="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Via Enel:"+e.getMessage());
			throw ea;
		}
