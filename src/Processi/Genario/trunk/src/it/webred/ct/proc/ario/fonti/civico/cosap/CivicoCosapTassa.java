...
public class CivicoCosapTassa extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoCosapTassa.class.getName());
	
	
	public CivicoCosapTassa(){
	...
	public String getSql(String processID) {
		...
		String sqlCivicoGas = this.getProperty("SQL_CIV_COSAP_TASSA");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Civico Cosap Tassa="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Cosap Tassa:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Cosap Tassa="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico Cosap Tassa:"+e.getMessage());
			throw ea;
		}
