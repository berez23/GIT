package it.webred.ct.proc.ario.fonti.via.cosap;
...
public class ViaCosapContribuente extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaCosapContribuente.class.getName());
	
	
	public ViaCosapContribuente(){
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_COSAP_CONTRIB");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Via Cosap Contribuente="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Cosap Contribunente:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Via Cosap Contribunente="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Via Cosap Contribunente:"+e.getMessage());
			throw ea;
		}
