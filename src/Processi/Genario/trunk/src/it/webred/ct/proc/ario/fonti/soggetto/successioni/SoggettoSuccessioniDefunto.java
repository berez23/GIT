...
import it.webred.ct.proc.ario.fonti.soggetto.locazioni.SoggettoLocazioni;
import it.webred.ct.proc.ario.normalizzazione.NormalizzaTotali;

public class SoggettoSuccessioniDefunto extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoSuccessioniDefunto.class.getName());
	
	
	public SoggettoSuccessioniDefunto(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggetto = this.getProperty("SQL_SOGG_SUCCESSIONI_DEFUNTO");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Successioni Defunto="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Successioni Defunto:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Successioni Defunto="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Successioni Defunto:"+e.getMessage());
			throw ea;
		}
