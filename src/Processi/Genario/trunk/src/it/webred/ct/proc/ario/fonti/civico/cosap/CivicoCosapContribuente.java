package it.webred.ct.proc.ario.fonti.civico.cosap;
...
public class CivicoCosapContribuente extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoCosapContribuente.class.getName());
	
	
	public CivicoCosapContribuente(){
	...
	public String getSql(String processID) {
		...
		String sqlCivicoGas = this.getProperty("SQL_CIV_COSAP_CONTRIB");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Civico Cosap Contribunente="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Cosap Contribunente:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Cosap Contribunente="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico Cosap Contribunente:"+e.getMessage());
			throw ea;
		}
