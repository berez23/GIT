package it.webred.ct.proc.ario.fonti.soggetto.cened;
...
public class ProprietarioCened extends DatoDwh implements Soggetto{

	private Properties props = null;	
	
	protected static final Logger log = Logger.getLogger(ProprietarioCened.class.getName());
	
	public ProprietarioCened(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoConcessioni = this.getProperty("SQL_SOGG_CENED_PROPRIETARIO");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoConcessioni = sqlSoggettoConcessioni + " AND PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Cened Proprietario: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Cened Proprietario: "+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Cened Proprietario: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Cened Proprietario: "+e.getMessage());
			throw ea;
		}
