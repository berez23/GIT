package it.webred.ct.proc.ario.fonti.soggetto.gas;
...
public class SoggettoGas extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoGas.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoGas = this.getProperty("SQL_SOGG_GAS");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoGas = sqlSoggettoGas + " WHERE g.PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Soggetto Gas="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Gas:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Soggetto Gas="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Gas:"+e.getMessage());
			throw ea;
		}
