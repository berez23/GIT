package it.webred.ct.proc.ario.fonti.civico.docfa;
...
public class CivicoDocfa extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoDocfa.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIVICO_DOCFA");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{									
			...
			log.warn("Errore:Save Civico Docfa="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Docfa:"+e.getMessage());
			throw ea;
		}
