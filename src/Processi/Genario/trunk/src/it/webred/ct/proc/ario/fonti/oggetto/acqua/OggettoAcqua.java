package it.webred.ct.proc.ario.fonti.oggetto.acqua;
...
public class OggettoAcqua extends DatoDwh implements Oggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(OggettoAcqua.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlOggetto = this.getProperty("SQL_OGG_ACQUA");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Oggetto Catasto Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Oggetto Catasto Acqua:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insOggettoTotale, String updateOggettoTotale, String searchOggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Oggetto Catasto Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Oggetto Catasto Acqua:"+e.getMessage());
			throw ea;
		}
