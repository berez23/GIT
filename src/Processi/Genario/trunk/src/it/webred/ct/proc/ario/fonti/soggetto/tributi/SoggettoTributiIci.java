...
public class SoggettoTributiIci extends DatoDwh implements Soggetto {

	private Properties props = null;	
	
	protected static final Logger log = Logger.getLogger(SoggettoTributiIci.class.getName());
	
	
	public SoggettoTributiIci(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoTributiIci = this.getProperty("SQL_SOGG_TRIBUTI_ICI");
		
		if (processID != null && !processID.equals("")){
			sqlSoggettoTributiIci = sqlSoggettoTributiIci + " WHERE PROCESSID =?";
			//sqlSoggettoTributiIci = sqlSoggettoTributiIci + " AND PROCESSID =?";
		}
			
		return sqlSoggettoTributiIci;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert,String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Tributi ICI="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Tributi ICI:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte,Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale,String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Tributi Ici="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Tributi Ici:"+e.getMessage());
			throw ea;
		}				
