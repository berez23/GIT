...
public class CivicoOggettoCompravendite extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoOggettoCompravendite.class.getName());
	
	
	public CivicoOggettoCompravendite(){
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIV_COMPRAV_OGG");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{									
			...
			log.warn("Errore:Save Civico Oggetto Compravendite="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico  Oggetto Compravendite:"+e.getMessage());
			throw ea;
		}
