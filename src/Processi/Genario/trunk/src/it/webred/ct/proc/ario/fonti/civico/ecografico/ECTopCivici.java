package it.webred.ct.proc.ario.fonti.civico.ecografico;
...
public class ECTopCivici extends DatoDwh implements Civici{
	...
	protected static final Logger log = Logger.getLogger(ECTopCivici.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlCivicoEcografico = this.getProperty("SQL_CIV_ECOGRAFICO");
						
		return sqlCivicoEcografico;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Civico Ecografico="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Ecografico:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Catasto Comunale="+e.getMessage(), e);
