package it.webred.ct.proc.ario.fonti.via.cened;
...
public class ViaCened extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaCened.class.getName());
	...
	public String getSql(String processID) {
		String sqlVia = this.getProperty("SQL_VIA_CENED");
		return sqlVia;
	}//-------------------------------------------------------------------------
...
//				sedime = sedime1;
			...
			log.warn("Errore:Save Via Cened "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Cened: "+e.getMessage());
			throw ea;
		}
