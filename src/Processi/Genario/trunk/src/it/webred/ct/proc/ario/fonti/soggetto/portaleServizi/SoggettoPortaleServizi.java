package it.webred.ct.proc.ario.fonti.soggetto.portaleServizi;
...
public class SoggettoPortaleServizi extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoPortaleServizi.class.getName());
	
	
	public SoggettoPortaleServizi(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggetto = this.getProperty("SQL_SOGG_PORTALESERVIZI");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto PortaleServizi ="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto PortaleServizi:"+e.getMessage());
			throw ea;
		}
