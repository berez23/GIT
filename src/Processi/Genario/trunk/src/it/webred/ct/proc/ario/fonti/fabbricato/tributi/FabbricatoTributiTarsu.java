package it.webred.ct.proc.ario.fonti.fabbricato.tributi;
...
public class FabbricatoTributiTarsu extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoTributiTarsu.class.getName());
	
	
	public FabbricatoTributiTarsu(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_TRIBUTI_TARSU");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			sft.setField4(rs.getString("FIELD5"));
			sft.setField4(rs.getString("FIELD6"));
			sft.setField4(rs.getString("FIELD7"));
			...
			log.warn("Errore:Save Fabbricato Tarsu="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Tarsu:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, String updateFabbricatoTotale, String searchFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Fabbricato Tarsu="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Fabbricato Tarsu:"+e.getMessage());
			throw ea;
		}
