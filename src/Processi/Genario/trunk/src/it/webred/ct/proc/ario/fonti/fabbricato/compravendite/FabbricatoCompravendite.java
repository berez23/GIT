package it.webred.ct.proc.ario.fonti.fabbricato.compravendite;
...
public class FabbricatoCompravendite extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoCompravendite.class.getName());
	
	
	public FabbricatoCompravendite(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricatoCompravendite = this.getProperty("SQL_FABB_COMPRAVENDITE");
				
		return sqlFabbricatoCompravendite;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Fabbricato Compravendite="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Compravendite:"+e.getMessage());
			throw ea;
		}
