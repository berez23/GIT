package it.webred.ct.proc.ario.fonti.soggetto.demografia;
...
public class SoggettoDemografia extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoDemografia.class.getName());
	
	
	public SoggettoDemografia(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoDemografia = this.getProperty("SQL_SOGG_DEMOGRAFIA");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoDemografia = sqlSoggettoDemografia + " AND PER.PROCESSID =?";
		}
			
		return sqlSoggettoDemografia;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Demografia="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Demografia:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Soggetto Demografia="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Demografia:"+e.getMessage());
			throw ea;
		}
