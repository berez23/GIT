package it.webred.ct.proc.ario.fonti.civico.pubblicita;
...
public class CivicoPubblicitaPratDettaglio extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoPubblicitaPratDettaglio.class.getName());
	
	
	public CivicoPubblicitaPratDettaglio(){
	...
	public String getSql(String processID) {
		...
		String sqlCivicoPub = this.getProperty("SQL_CIV_PUBBLICITA_DETTAGLIO");
				
		if (processID != null && !processID.equals("")){
			sqlCivicoPub = sqlCivicoPub + " WHERE PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Civico Pubblicita Dettaglio="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Pubblicita Dettaglio:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, String updateCivicoTotale, String searchCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Civico Pubblicita Dettaglio="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Civico Pubblicita Dettaglio:"+e.getMessage());
			throw ea;
		}
	...
	private String getProperty(String propName) {
		...
		log.debug(propName+ "." + this.getFkEnteSorgente() + " SQL Civico_Pubblicita_Prat_Dettaglio["+p+"]");
