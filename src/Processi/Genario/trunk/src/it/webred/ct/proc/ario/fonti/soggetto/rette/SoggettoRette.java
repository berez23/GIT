package it.webred.ct.proc.ario.fonti.soggetto.rette;
...
public class SoggettoRette extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoRette.class.getName());
	
	
	public SoggettoRette(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoGas = this.getProperty("SQL_SOGG_RETTE");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoGas = sqlSoggettoGas + " WHERE PROCESSID =?";
		}
			
		return sqlSoggettoGas;
	...
	public String getTable() {
		...
		String tabella = "SIT_RTT_SOGG_BOLLETTE";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Soggetto Rette="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Rette:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Soggetto Rette="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Rette:"+e.getMessage());
			throw ea;
		}
