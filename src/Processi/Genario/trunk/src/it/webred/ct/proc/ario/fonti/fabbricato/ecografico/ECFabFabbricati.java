package it.webred.ct.proc.ario.fonti.fabbricato.ecografico;
...
public class ECFabFabbricati extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ECFabFabbricati.class.getName());
	
	
	public ECFabFabbricati(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_ECOGRAFICO");
	...
	public String getTable() {
		...
		String tabella = "EC_FAB_FABBRICATI";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs,String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Fabbricato Ecografico="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Ecografico:"+e.getMessage());
			throw ea;
		}
