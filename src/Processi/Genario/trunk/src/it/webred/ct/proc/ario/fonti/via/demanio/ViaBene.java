package it.webred.ct.proc.ario.fonti.via.demanio;
...
public class ViaBene extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaBene.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_DEMANIO");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Bene Demanio"+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Bene Demanio:"+e.getMessage());
			throw ea;
		}
