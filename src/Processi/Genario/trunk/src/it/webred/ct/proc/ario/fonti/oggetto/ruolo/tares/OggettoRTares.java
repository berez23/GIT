package it.webred.ct.proc.ario.fonti.oggetto.ruolo.tares;
...
public class OggettoRTares extends DatoDwh implements Oggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(OggettoRTares.class.getName());
	private String desc = "Oggetto Ruolo Tares";
	
	public OggettoRTares(){
	...
	public String getSql(String processID) {
		...
		String sqlOggetto = this.getProperty("SQL_OGG_R_TARES");
				
		if (processID != null && !processID.equals("")){
			sqlOggetto = sqlOggetto + " AND PROCESSID =?";
		}
