package it.webred.ct.proc.ario.fonti.fabbricato.locazioni;
...
public class FabbricatoLocazioni extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoLocazioni.class.getName());
	
	
	public FabbricatoLocazioni(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_LOCAZIONI");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs,String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Fabbricato Locazioni="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Locazioni:"+e.getMessage());
			throw ea;
		}
