package it.webred.ct.proc.ario.fonti.fabbricato.acqua;
...
public class FabbricatoAcqua extends DatoDwh implements Fabbricato{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(FabbricatoAcqua.class.getName());
	
	
	public FabbricatoAcqua(){
	...
	public String getSql(String processID) {
		...
		String sqlFabbricato = this.getProperty("SQL_FABB_ACQUA");
	...
	public String getTable() {
		...
		String tabella = "SIT_ACQUA_CATASTO";		
		return tabella;
	}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Fabbricato Catasto Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Fabbricato Catasto Acqua:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insFabbricatoTotale, String updateFabbricatoTotale, String searchFabbricatoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Update Fabbricato Catasto Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Fabbricato Catasto Acqua:"+e.getMessage());
			throw ea;
		}
