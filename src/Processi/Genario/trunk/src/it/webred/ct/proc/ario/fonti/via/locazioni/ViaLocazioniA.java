...
public class ViaLocazioniA extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaLocazioniA.class.getName());
	
	
	public ViaLocazioniA(){
	...
	public String getSql(String processID) {
		...
		String sqlViaLocazioniA = this.getProperty("SQL_VIA_LOCAZIONI");
						
		return sqlViaLocazioniA;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Locazioni A="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Locazioni A:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Via Locazioni A="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Via Locazioni A:"+e.getMessage());
			throw ea;
		}
