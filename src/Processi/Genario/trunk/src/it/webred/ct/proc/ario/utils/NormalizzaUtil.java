...
public class NormalizzaUtil {
	...
	static{
		...
		try {	
			InputStream is = NormalizzaUtil.class.getResourceAsStream("/titoli.properties");
		    propsTitoli.load(is);   		    		    
		}catch(Exception e) {
	...
	public static void paddingFabbricato(SitFabbricatoTotale sft) throws Exception{
		...
		try{
			...
			sft.setSubalterno(StringUtils.padding(sft.getSubalterno()!=null?sft.getSubalterno().trim():null, 4, '0', true));
