...
public class CivicoUtenteAcqua extends DatoDwh implements Civici{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(CivicoUtenteAcqua.class.getName());
	
	
	public CivicoUtenteAcqua(){
	...
	public String getSql(String processID) {
		...
		String sqlCivico = this.getProperty("SQL_CIV_ACQUA_UTENTE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insCivicoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{									
			...
			log.warn("Errore:Save Civico Utente Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Civico Utente Acqua:"+e.getMessage());
			throw ea;
		}
