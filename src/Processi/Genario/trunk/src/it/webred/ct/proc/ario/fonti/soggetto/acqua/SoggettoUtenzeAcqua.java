...
public class SoggettoUtenzeAcqua extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoUtenzeAcqua.class.getName());
	
	
	public SoggettoUtenzeAcqua(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoMulte = this.getProperty("SQL_SOGG_ACQUA_UTENZE");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoMulte = sqlSoggettoMulte + " AND PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Soggetto Utenze Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Utenze Acqua:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, String updateSoggettoTotale, String searchSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Soggetto Utenze Acqua="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Soggetto Utenze Acqua:"+e.getMessage());
			throw ea;
		}
