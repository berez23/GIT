...
public class CertificatoreCened extends DatoDwh implements Soggetto{

	private Properties props = null;	
	
	protected static final Logger log = Logger.getLogger(CertificatoreCened.class.getName());
	
	public CertificatoreCened(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoConcessioni = this.getProperty("SQL_SOGG_CENED_CERTIFICATORE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Cened Certificatore: "+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Cened Certificatore: "+e.getMessage());
			throw ea;
		}
