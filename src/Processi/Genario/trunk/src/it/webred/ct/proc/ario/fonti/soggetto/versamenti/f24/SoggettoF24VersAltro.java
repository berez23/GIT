...
public class SoggettoF24VersAltro extends DatoDwh implements Soggetto  {

	
	private Properties props = null;
	private Properties propsCodSogg = null;
	
	protected static final Logger log = Logger.getLogger(SoggettoF24VersAltro.class.getName());
	
	
	public SoggettoF24VersAltro(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggettoVersContrib = this.getProperty("SQL_SOGG_F24_VERS_ALTRO");
				
		if (processID != null && !processID.equals("")){
			sqlSoggettoVersContrib = sqlSoggettoVersContrib + " AND PROCESSID =?";
		}
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto CF2 Versamenti F24="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto CF2 Versamenti F24:"+e.getMessage());
			throw ea;
		}
