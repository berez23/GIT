package it.webred.ct.proc.ario.fonti.via.multe;
...
public class ViaMulte extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaMulte.class.getName());
	...
	public String getSql(String processID) {
		...
		String sqlVia = this.getProperty("SQL_VIA_MULTE");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Save Via Multe="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Multe:"+e.getMessage());
			throw ea;
		}
