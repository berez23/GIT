...
public class SoggettoTecnicoDocfa extends DatoDwh implements Soggetto{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(SoggettoTecnicoDocfa.class.getName());
	
	
	public SoggettoTecnicoDocfa(){
	...
	public String getSql(String processID) {
		...
		String sqlSoggetto = this.getProperty("SQL_SOGG_DOCFA_TECNICO");
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insSoggettoTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{			
			...
			log.warn("Errore:Save Soggetto Docfa Tecnico ="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Soggetto Docfa Tecnico:"+e.getMessage());
			throw ea;
		}
