package it.webred.ct.proc.ario.fonti.via.locazioni;
...
public class ViaLocazioniB extends DatoDwh implements Via{

	private Properties props = null;
	protected static final Logger log = Logger.getLogger(ViaLocazioniB.class.getName());
	
	
	public ViaLocazioniB(){
	...
	public String getSql(String processID) {
		...
		String sqlViaLocazioniB = this.getProperty("SQL_VIA_LOCAZIONI2");
						
		return sqlViaLocazioniB;
	...
	public void prepareSaveDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			/*Indirizzo<String, String> ind1 = GestioneStringheVie.restituisciIndirizzo(indirizzo, null);
			indirizzo= ind1.getInd();
			String sedime = ind1.getSed();*/
			...
			log.warn("Errore:Save Via Locazioni B="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Save Via Locazioni B:"+e.getMessage());
			throw ea;
		}
	...
	public void prepareUpdateDato(DatoDwh classeFonte, Connection connForInsert, String insViaTotale, String updateViaTotale, String searchViaTotale, ResultSet rs, String codEnte, HashParametriConfBean paramConfBean) throws Exception {
		...
		try{		
			...
			log.warn("Errore:Update Via Locazioni B="+e.getMessage(), e);
			Exception ea = new Exception("Errore:Update Via Locazioni B:"+e.getMessage());
			throw ea;
		}
