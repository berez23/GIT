...
/**
 * The persistent class for the SIT_T_TAR_ULT_SOGG database table.
 * 
 */
@Entity
@Table(name="SIT_T_TAR_ULT_SOGG")
public class SitTTarUltSogg implements Serializable {
	...
	public String getIdExtOggRsu() {
		return this.idExtOggRsu;
	}

	public void setIdExtOggRsu(String idExtOggRsu) {
		this.idExtOggRsu = idExtOggRsu;
	}
