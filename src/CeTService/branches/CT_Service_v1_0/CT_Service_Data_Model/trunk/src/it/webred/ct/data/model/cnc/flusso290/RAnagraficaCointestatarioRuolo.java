...
/**
 * The persistent class for the RE_CNC_N3_ANA_COOB_COIN database table.
 * 
 */
@Entity
@Table(name="RE_CNC_N3_ANA_COOB_COIN")
public class RAnagraficaCointestatarioRuolo implements Serializable {
	...
	@Column(name="COD_NAT_GIURID_DEB")
	private String codNatGiuridDeb;
    ...
    public RAnagraficaCointestatarioRuolo() {
    }
	...
	public String getCodNatGiuridDeb() {
		return this.codNatGiuridDeb;
	}

	public void setCodNatGiuridDeb(String codNatGiuridDeb) {
		this.codNatGiuridDeb = codNatGiuridDeb;
	}
