...
/**
 * The primary key class for the CONS_CONS_TAB database table.
 * 
 */
@Embeddable
public class ConsConsTabPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ConsConsTabPK)) {
			return false;
		}
		ConsConsTabPK castOther = (ConsConsTabPK)other;
		return 
