...
/**
 * The persistent class for the SIT_D_PERSONA_CIVICO database table.
 * 
 */
@Entity
@Table(name="SIT_D_PERSONA_CIVICO")
public class SitDPersonaCivico implements Serializable {
	...
	@Column(name="ID_EXT_D_CIVICO")
	private String idExtDCivico;
	...
	public String getIdExtDCivico() {
		return this.idExtDCivico;
	}

	public void setIdExtDCivico(String idExtDCivico) {
		this.idExtDCivico = idExtDCivico;
	}
