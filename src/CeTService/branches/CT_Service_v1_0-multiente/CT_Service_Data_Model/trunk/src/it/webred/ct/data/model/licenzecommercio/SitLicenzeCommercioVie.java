...
/**
 * The persistent class for the SIT_LICENZE_COMMERCIO_VIE database table.
 * 
 */
@Entity
@Table(name="SIT_LICENZE_COMMERCIO_VIE")
@IndiceEntity(sorgente="13")
public class SitLicenzeCommercioVie implements Serializable {
