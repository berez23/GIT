...
public class TarsuJPAImpl extends TarsuBaseDAO implements TarsuDAO {
	...
	public SitTTarVia getViaByIdExt(RicercaViaTarsuDTO rv)  throws TarsuServiceException {
		SitTTarVia via =null;
		try {
			System.out.println("TarsuJPAImpl.getViaByIdExt - IdExt:  ["+rv.getDatiVia().getIdExt()+"]");
	...
	@Override
	public List<SitTTarOggetto> getListaOggettiByFabbricato(RicercaOggettoDTO ro) 	throws TarsuServiceException {
	...
	public List<SitTTarOggetto> getListaOggettiAiCiviciTarsu(RicercaOggettoTarsuDTO ro)	throws TarsuServiceException {
		List<SitTTarOggetto> lista = new ArrayList<SitTTarOggetto>();
		logger.debug("getOggettiAiCiviciTarsu -  LISTA OGGETTI TARSU PER CIVICI TARSU");
		Query q =null;
		try{
