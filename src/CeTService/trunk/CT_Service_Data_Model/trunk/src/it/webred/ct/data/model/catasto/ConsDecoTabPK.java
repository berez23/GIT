...
/**
 * The primary key class for the CONS_DECO_TAB database table.
 * 
 */
@Embeddable
public class ConsDecoTabPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ConsDecoTabPK)) {
			return false;
		}
		ConsDecoTabPK castOther = (ConsDecoTabPK)other;
		return 
