...
/**
 * The persistent class for the SIT_RUOLO_TARES_ST_SG database table.
 * 
 */
@Entity
@Table(name="SIT_RUOLO_TARES_ST_SG")
public class SitRuoloTaresStSg implements Serializable {
