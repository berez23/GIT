...
/**
 * The persistent class for the SIT_T_TAR_CONTRIB database table.
 * 
 */
@Entity
@Table(name="SIT_T_TAR_CONTRIB")
public class SitTTarContrib implements Serializable {
