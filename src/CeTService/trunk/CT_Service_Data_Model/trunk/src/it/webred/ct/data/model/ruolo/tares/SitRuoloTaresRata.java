...
/**
 * The persistent class for the SIT_RUOLO_TARES_RATA database table.
 * 
 */
@Entity
@Table(name="SIT_RUOLO_TARES_RATA")
public class SitRuoloTaresRata implements Serializable {
