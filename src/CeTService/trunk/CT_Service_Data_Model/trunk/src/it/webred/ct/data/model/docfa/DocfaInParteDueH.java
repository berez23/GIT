...
public class DocfaInParteDueH implements Serializable {
	...
	public String getCtSubalterno01() {
		if(ctSubalterno01!=null)
			return ctSubalterno01.trim();
		else return null;
	}
	...
	public String getCtSubalterno02() {
		if(ctSubalterno02!=null)
			return ctSubalterno02.trim();
		else return null;
	}
	...
	public String getCtSubalterno03() {
		if(ctSubalterno03!=null)
			return ctSubalterno03.trim();
		else return null;
	}
	...
	public String getCtSubalterno04() {
		if(ctSubalterno04!=null)
			return ctSubalterno04.trim();
		else return null;
	}
