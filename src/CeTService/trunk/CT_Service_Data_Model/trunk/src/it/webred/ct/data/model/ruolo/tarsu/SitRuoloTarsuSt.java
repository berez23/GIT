...
/**
 * The persistent class for the SIT_RUOLO_TARSU_ST database table.
 * 
 */
@Entity
@Table(name="SIT_RUOLO_TARSU_ST")
public class SitRuoloTarsuSt implements Serializable {
