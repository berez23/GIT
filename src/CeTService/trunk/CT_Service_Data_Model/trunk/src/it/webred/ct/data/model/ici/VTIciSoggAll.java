...
/**
 * The persistent class for the V_T_ICI_SOGG_ALL database table.
 * 
 */
@Entity
@Table(name="V_T_ICI_SOGG_ALL")
public class VTIciSoggAll implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private VIciTSoggAllPK id;
	...
	public VIciTSoggAllPK getId() {
		return this.id;
	}

	public void setId(VIciTSoggAllPK id) {
		this.id = id;
	}
	...
	public String getTipoSoggetto() {
		return this.id.getTipoSoggetto();
	}

	public void setTipoSoggetto(String tipoSoggetto) {
		this.id.setTipoSoggetto(tipoSoggetto);
	}
