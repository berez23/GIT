...
public class AnagGenQueryBuilder {
	...
	private String getSQLCriteria() {
		...
		sqlCriteria = (criteri.getCognome() == null  || criteri.getCognome().equals("") ? sqlCriteria : sqlCriteria + " AND COGNOME='" + criteri.getCognome() + "'");
		sqlCriteria = (criteri.getNome() == null  || criteri.getNome().equals("") ? sqlCriteria : sqlCriteria + " AND NOME='" + criteri.getNome() + "'");
		String dataStr="";
