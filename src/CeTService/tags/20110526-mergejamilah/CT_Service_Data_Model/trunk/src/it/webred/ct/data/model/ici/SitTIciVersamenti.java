...
/**
 * The persistent class for the SIT_T_ICI_VERSAMENTI database table.
 * 
 */
@Entity
@Table(name="SIT_T_ICI_VERSAMENTI")
public class SitTIciVersamenti implements Serializable {
	...
	@Column(name="FLG_ACC_SAL")
	private String flgAccSal;
	...
	@Column(name="ID_EXT_SOGG_ICI")
	private String idExtSoggIci;
	...
	@Column(name="IMP_ABI_PRI_EU")
	private BigDecimal impAbiPriEu;

	@Column(name="IMP_ALT_FAB_EU")
	private BigDecimal impAltFabEu;

	@Column(name="IMP_ARE_FAB_EU")
	private BigDecimal impAreFabEu;

	@Column(name="IMP_DTR_EU")
	private BigDecimal impDtrEu;

	@Column(name="IMP_PAG_EU")
	private BigDecimal impPagEu;

	@Column(name="IMP_TER_AGR_EU")
	private BigDecimal impTerAgrEu;
	...
	@Column(name="NUM_BOLL")
	private BigDecimal numBoll;
	...
	public String getFlgAccSal() {
		return this.flgAccSal;
	}

	public void setFlgAccSal(String flgAccSal) {
		this.flgAccSal = flgAccSal;
	}
	...
	public String getIdExtSoggIci() {
		return this.idExtSoggIci;
	}

	public void setIdExtSoggIci(String idExtSoggIci) {
		this.idExtSoggIci = idExtSoggIci;
	}
	...
	public BigDecimal getImpAbiPriEu() {
		return this.impAbiPriEu;
	}

	public void setImpAbiPriEu(BigDecimal impAbiPriEu) {
		this.impAbiPriEu = impAbiPriEu;
	}

	public BigDecimal getImpAltFabEu() {
		return this.impAltFabEu;
	}

	public void setImpAltFabEu(BigDecimal impAltFabEu) {
		this.impAltFabEu = impAltFabEu;
	}

	public BigDecimal getImpAreFabEu() {
		return this.impAreFabEu;
	}

	public void setImpAreFabEu(BigDecimal impAreFabEu) {
		this.impAreFabEu = impAreFabEu;
	}

	public BigDecimal getImpDtrEu() {
		return this.impDtrEu;
	}

	public void setImpDtrEu(BigDecimal impDtrEu) {
		this.impDtrEu = impDtrEu;
	}

	public BigDecimal getImpPagEu() {
		return this.impPagEu;
	}
	...
	public BigDecimal getImpTerAgrEu() {
		return this.impTerAgrEu;
	}

	public void setImpTerAgrEu(BigDecimal impTerAgrEu) {
	...
	public BigDecimal getNumBoll() {
		return this.numBoll;
	}

	public void setNumBoll(BigDecimal numBoll) {
		this.numBoll = numBoll;
	}
	...
	public BigDecimal getNumFab() {
		return this.numFab;
	}

	public void setNumFab(BigDecimal numFab) {
		this.numFab = numFab;
	}
