...
/**
 * The persistent class for the V_T_TAR_SOGG_ALL database table.
 * 
 */
@Entity
@Table(name="V_T_TAR_SOGG_ALL")
public class VTTarSoggAll implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VTTarSoggAllPK id;
	...
	public VTTarSoggAllPK getId() {
		return id;
	}

	public void setId(VTTarSoggAllPK id) {
		this.id = id;
	}
