...
/**
 * The persistent class for the SIT_C_CONC_INDIRIZZI database table.
 * 
 */
@Entity
@Table(name="SIT_C_CONC_INDIRIZZI")
@IndiceEntity(sorgente="3")
public class SitCConcIndirizzi implements Serializable {
	...
	@Transient
	@Column(name="CIVICO_COMPOSTO")
	private Object civicoComposto;
	...
	public Object getCivicoComposto() {
		return this.civicoComposto;
	}

	public void setCivicoComposto(Object civicoComposto) {
