...
/**
 * The persistent class for the SIT_LICENZE_COMMERCIO_TIT database table.
 * 
 */
@Entity
@Table(name="SIT_LICENZE_COMMERCIO_TIT")
@IndiceEntity(sorgente="13")
public class SitLicenzeCommercioTit implements Serializable {
	...
	@Column(name="ID_EXT_ANAGRAFICA")
	private String idExtAnagrafica;

	@Column(name="ID_EXT_AUTORIZZAZIONE")
	private String idExtAutorizzazione;
	...
	public String getIdExtAnagrafica() {
		return this.idExtAnagrafica;
	}

	public void setIdExtAnagrafica(String idExtAnagrafica) {
		this.idExtAnagrafica = idExtAnagrafica;
	}

	public String getIdExtAutorizzazione() {
		return this.idExtAutorizzazione;
	}

	public void setIdExtAutorizzazione(String idExtAutorizzazione) {
		this.idExtAutorizzazione = idExtAutorizzazione;
	}
