...
/**
 * The persistent class for the SIT_COMUNE database table.
 * 
 */
@Entity
@Table(name="SIT_COMUNE")
public class SitComune implements Serializable {
	...
	@Column(name="ID_EXT_D_PROVINCIA")
	private String idExtDProvincia;
	...
	public String getIdExtDProvincia() {
		return this.idExtDProvincia;
	}

	public void setIdExtDProvincia(String idExtDProvincia) {
		this.idExtDProvincia = idExtDProvincia;
	}
