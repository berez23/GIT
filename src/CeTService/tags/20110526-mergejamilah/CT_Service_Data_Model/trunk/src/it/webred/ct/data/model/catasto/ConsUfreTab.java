...
/**
 * The persistent class for the CONS_UFRE_TAB database table.
 * 
 */
@Entity
@Table(name="CONS_UFRE_TAB")
public class ConsUfreTab implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ConsUfreTabPK id;
	...
	@Column(name="PKID_UFFR")
	private BigDecimal pkidUffr;
	...
	public ConsUfreTabPK getId() {
		return this.id;
	}

	public void setId(ConsUfreTabPK id) {
		this.id = id;
	}
	...
	public BigDecimal getPkidUffr() {
		return this.pkidUffr;
	}

	public void setPkidUffr(BigDecimal pkidUffr) {
		this.pkidUffr = pkidUffr;
	}
