...
{
	this.daylist = new Array('Do','Lu','Ma','Me','Gi','Ve','Sa','Do','Lu','Ma','Me','Gi','Ve','Sa'); /*<lang:en>*/
	this.months_sh = new Array('Gen','Feb','Mar','Apr','Mag','Giu','Lug','Ago','Set','Ott','Nov','Dic');
	this.monthup_title = 'Vai al mese successivo';
	this.monthdn_title = 'Vai al mese precedente';
	this.clearbtn_caption = 'Pulisci';
	this.clearbtn_title = 'Pulisci qualsiasi data selezionata';
	this.maxrange_caption = 'Questo è il range massimo';
};
//-----------------------------------------------------------------------------
