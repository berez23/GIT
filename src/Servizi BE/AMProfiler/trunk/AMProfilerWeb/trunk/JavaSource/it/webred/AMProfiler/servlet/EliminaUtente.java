 ...
 * 
 */
public class EliminaUtente extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			if (validate(request)) {
				BaseAction.EliminaUtente(request);
			}
			...
			request.setAttribute("noCancellazioneUtente", "true");
			request.setAttribute("msgCancellazioneUtente", "Errore non previsto nell'eliminazione utente");
		}
