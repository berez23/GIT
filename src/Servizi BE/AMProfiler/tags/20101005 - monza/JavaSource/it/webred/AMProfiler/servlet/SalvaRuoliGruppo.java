 ...
 * 
 */
public class SalvaRuoliGruppo extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			BaseAction.SalvaRuoliGruppo(request);
