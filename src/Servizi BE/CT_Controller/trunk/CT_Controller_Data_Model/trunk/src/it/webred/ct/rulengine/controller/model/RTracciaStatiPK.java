 ...
 */
@Embeddable
public class RTracciaStatiPK implements Serializable {
    ...
    public RTracciaStatiPK() {
    }
    
	public RTracciaStatiPK(String belfiore, Long idFonte, Long istante) {
		super();
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RTracciaStatiPK)) {
			return false;
		}
		RTracciaStatiPK castOther = (RTracciaStatiPK)other;
		return 
