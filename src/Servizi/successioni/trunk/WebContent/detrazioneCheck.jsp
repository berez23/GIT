...
<div class="section">
<h2>SUCCESSIONI - CONTROLLO DETRAZIONE PRIMA CASA</h2>
<div class="section">
...
<c:if test="${empty OGGETTO_CON_DETRAZIONE}">
	<table class="bodyTable">
		<tbody>
			<tr class="a">
				<td class="a_title" align="center" colspan="1">${SOGGETTO.nome } ${SOGGETTO.cognome } NON HA Diritto alla detrazione per nessun immobile della nota ${SOGGETTO.miDupNotaTras.idNota }/${SOGGETTO.miDupNotaTras.annoNota }</td>
			</tr> 
		</tbody>
	</table>
</c:if>
