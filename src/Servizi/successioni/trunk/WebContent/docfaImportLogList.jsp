...
<display:table export="false" uid="log" name="${DocfaDataLogs}" pagesize="25" sort="external" defaultsort="1" defaultorder="descending">
  ...
  <display:column  href="docfaDetail.jsp?backTarget=docfaImportLogList.jsp&backTargetLabel=Torna%20alla%20lista%20dei%20log%20di%20Importazione&docfaKey=${log.idFornitura }-${ log.idProtocollo}"  title="DOCFA" >
