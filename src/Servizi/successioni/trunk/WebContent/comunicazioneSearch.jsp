...
<div class="section">
<h2>SUCCESSIONI - FILTRO COMUNICAZIONI ICI</h2>
<div class="section">
<p>
...
<table class="bodyTable">
	<tbody>
		...
		<tr class="b">
			...
			<td align="left"><input type="text" class="muiinput" value="" name="numeroNotaTras"/></td>
		</tr>
		<tr class="b">
			...
			<td align="left">
				<sql:query dataSource="jdbc/mui" var="anni_nota">
					select distinct anno_nota from suc_dup_nota_tras order by anno_nota
				</sql:query>
		...
		<tr class="b">
			...
			<td align="left">
				<sql:query dataSource="jdbc/mui" var="categorie">
					select distinct categoria as codice from suc_dup_fabbricati_info order by categoria
				</sql:query>
		...
		<tr class="b">
			...
			<td align="left"><select name="clause_renditaEuro"><option value="EQUAL_NUM">uguale a</option><option value="MORE_THAN">maggiore di</option><option value="LESS_THAN">minore di</option><option value="MORE_OR_EQUAL_THAN">maggiore o uguale a</option><option value="LESS_OR_EQUAL_THAN">minore o uguale a</option></select></td>
