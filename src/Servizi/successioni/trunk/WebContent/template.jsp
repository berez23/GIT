...
<security:lock role="succ-adm,succ-supusr,succ-usr">
<div class="xleft" style="display: none;">
	Versione: @@version.label@@
</div>
<div class="xleft">
...
<div id="leftColumn">
	<div id="navcolumn">
	<security:lock role="succ-adm,succ-usr,succ-supusr">
		...
		<ul>
			...
			<security:lock role="succ-adm,succ-supusr">
				...
				<li class="none"><a href="uploadFromDB.jsp">Carica Forniture (da DB)</a></li>
				<li class="none"><a href="uploadList.jsp?toExport=y">Esporta Forniture</a></li>
				<li class="none"><a href="cfrList.jsp" onclick="javascript:return confirm('L\'operazione di confronto dati forniture può richiedere diversi minuti: continuare?')">Confronta Forniture</a></li>
			</security:lock>
		</ul>
	</security:lock>
	<!-- <security:lock role="succ-adm,succ-usr,succ-supusr">
	...
	(video e stampa)</h5>
	<ul>
		<li class="none"><a href="noteSearch.jsp">Note di Successione</a></li>
	...
	<security:lock role="succ-adm,succ-supusr">
		...
		<ul>
			...
			<security:lock role="succ-supusr">
