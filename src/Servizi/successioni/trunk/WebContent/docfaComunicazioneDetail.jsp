...
<input type="hidden" value="${comunicazione.iidComunicazione }" name="iid" />
<input type="hidden" value="1" name="flagElaborato" />
<table class="bodyTable">
	<tbody>
			...
			<table>
				<tr>
					...
					<td colspan="3"><input type="text" size="20"
						value="${comunicazione.codfiscalePiva }" name="codfiscalePiva" /></td>
				...
				<tr>
					...
					<td colspan="3"><input type="text" size="50"
						value="${comunicazione.denominazione}" name="denominazione" /></td>
					<td class="a">Nome</td>
					<td colspan="3"><input type="text" size="50"
						value="${comunicazione.nome}" name="nome" /></td>
				</tr>
				<tr>
					<td class="a">data di nascita(gg/MM/aaaa) </td>
					<td colspan="7">
					<table cellspacing="0">
						<tr align="left">
							
							<td colspan="1">
								<input type="text" size="12" value="${comunicazione.dataNascita }" name="dataNascita"  />
								</td>
					...
					<table cellspacing="0">
						<tr align="left">
							<td colspan="1">
								...
								value="${comunicazione.dataNascitarl}" 
								name="dataNascitarl" />
								</td>
							<td class="a">comune di nascita</td>
							<td colspan="3"><input type="text" size="50"
		...
		<c:forEach var="oggetto" varStatus="status"
			items="${comunicazione.docfaComunOggettos}">
		<tr class="a">
			...
			<table>
					...
					<table cellspacing="0">
						<tr align="left">
							...
							<td colspan="3"><input type="text" size="30"
								value="${oggetto.descVariazione}"
								name="oggetto.${oggetto.iid }.descrizioneVariazione" readonly="readonly" /></td>
						</tr>
					</table>
					</td>
					<td class="a">decorrenza(gg/MM/aaaa) </td>
					<td colspan="1">
						<input type="text" size="12"
						value="${oggetto.decorrenza }" name="oggetto.${oggetto.iid }.decorrenza"
						/> 
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<table cellspacing="0">
						<tr align="left">
							...
							<td class="a">sezione</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.sezioneVar" /></td>
							<td class="a">foglio</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.foglioVar" /></td>
							<td class="a">particella</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.particellaVar" /></td>
							<td class="a">subalterno</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.subalternoVar" /></td>
							<td class="a">numero protocollo</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.numeroProtocolloVar" /></td>
							<td class="a">anno</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.annoVar" /></td>
							<td class="a">categoria</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.categoriaVar" /></td>
							<td class="a">classe</td>
							<td colspan="1"><input type="text" size="5"
								value="" name="oggetto.${oggetto.iid }.classeVar" /></td>
						</tr>
					</table>
					</td>
				</tr>
				<tr>
					...
					<table cellspacing="0">
						<tr align="right">
							...
							<c:if test="${oggetto.flagPossessoDirittoAbit}" ><c:set var="flagPossessoDirittoAbitazione" > checked="checked" </c:set></c:if>
				...
				<tr>
					...
					<table cellspacing="0">
						...
						<tr align="center">
							<c:if test="${oggetto.flagAbitPrincipale}" ><c:set var="flagAbitazionePrincipale" > checked="checked" </c:set></c:if>
							...
							<td  rowspan="2"  align="left"><input type="text" size="5"
								value="${oggetto.contitolariAbitPrincipale}" name="oggetto.${oggetto.iid }.contitolariAbitazionePrincipale" /></td>
						</tr>
						<tr align="center">
							<c:if test="${oggetto.flagAbitPrincipaleNm}" ><c:set var="flagAbitazionePrincipaleNoMore" > checked="checked" </c:set></c:if>
				...
				<tr>
					...
					<table cellspacing="0">
						<tr align="left">
							...
							<c:if test="${oggetto.flagDetrazioneDelib}" ><c:set var="flagDetrazioneDelibera" > checked="checked" </c:set></c:if>
						...
						<tr align="left">
							<c:if test="${oggetto.flagDetrazioneDelibNm}" ><c:set var="flagDetrazioneDeliberaNM" > checked="checked" </c:set></c:if>
		...
		<tr class="b">
			...
			<td align="right"><security:lock role="succ-adm,succ-supusr"><input type="submit" class="muiinput" value="Salva" name="Salva"/></security:lock></td>
			<td align="left"><input type="reset" class="muiinput" value="Stampa" name="Stampa" onclick="popUp('docfaIciPdfNoTemplate?iidComunicazione=${ comunicazione.iidComunicazione}');return false"/>
			<input type="reset" class="muiinput" value="Controlla Detrazione" name="Controlla Detrazione" onclick="popUp('docfaDetrazioneCheckNoTemplate.jsp?CF=${comunicazione.codfiscalePiva}&DR=${comunicazione.dataRegistrazione}&PRT=${comunicazione.iidProtocolloReg}&FORN=${comunicazione.iidFornitura}');return false"/><input type="reset" class="muiinput" value="Reset" name="Reset"/></td>
