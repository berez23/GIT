...
public class SecurityLockTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		while (i < roles.length){			
			...
			//hasRole = GestionePermessi.autorizzato(request.getUserPrincipal(),request.getContextPath().substring(1),"Successioni",roles[i]);
			//per ora inibito - verificare se e come gestire - Filippo Mazzini 15.04.13
			hasRole = true;
			///////////////////////////////////////////////////////////////////////////
			if(hasRole) break;
			i++;
