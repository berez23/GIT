...
//					.getMiConsComunicaziones().iterator().next() : null);
			...
			if (comunicazione == null) {
				...
				while (iterator.hasNext()) {
					...
					// 20-03-2009 marcoric: tolto e valorizzato in detrazionenmanager 
					...
					if (fabbricato != null) {
						...
						// Modified by MaX 19/08/2007 - Per evitare che riporti nel campo indirizzo la stringa "null"
						...
						if (identificas != null && identificas.size() > 0) {
							...
							try {
								...
								Logger.log().info(ComunicazioneConverter.class.getName(), "Reddito: " + oggetto.getRedditoEuro());
							} catch (Throwable e) {
								Logger.log().error(
					...
					oggetto.setPercentualePossesso(titolarita.getQuota()!=null?titolarita.getQuota().multiply(new BigDecimal(100)):new BigDecimal(0));
