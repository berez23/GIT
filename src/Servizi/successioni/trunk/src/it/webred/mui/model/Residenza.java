...
public class Residenza implements Comparable {
	...
	public boolean matchIndirizzo(Residenza resid) {
		boolean match = (compareNullableValue(getCodiceVia(), resid.getCodiceVia()) == 0 
						&& compareNullableValue(getNumeroCivico(), resid.getNumeroCivico()) == 0);
		return match;
	}
