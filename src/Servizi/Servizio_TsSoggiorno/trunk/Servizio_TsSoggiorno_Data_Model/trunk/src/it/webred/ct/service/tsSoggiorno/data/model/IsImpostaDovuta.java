...
/**
 * The persistent class for the IS_IMPOSTA_DOVUTA database table.
 * 
 */
@Entity
@Table(name="IS_IMPOSTA_DOVUTA")
public class IsImpostaDovuta implements Serializable {
