...
/**
 * The persistent class for the IS_MODULO_EVENTI database table.
 * 
 */
@Entity
@Table(name="IS_MODULO_EVENTI")
public class IsModuloEventi implements Serializable {
