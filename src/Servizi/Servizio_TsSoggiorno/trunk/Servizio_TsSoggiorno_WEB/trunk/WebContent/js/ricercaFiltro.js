function setTxtSocieta(suggestionBox){
	var items = suggestionBox.getSelectedItems();
	if (items[0] != null) {
		 document.getElementById("frmRimbSanz:idSocieta").value = items[0].societa.id;
		 document.getElementById("frmRimbSanz:txtSocieta").value = items[0].societa.ragSoc;
		 document.getElementById("frmRimbSanz:idStruttura").value = '';
		 document.getElementById("frmRimbSanz:txtStruttura").value = '';
		 document.getElementById("frmRimbSanz:txtStruttura").disabled = false;
	} else {
		 document.getElementById("frmRimbSanz:idSocieta").value = '';
		 document.getElementById("frmRimbSanz:idStruttura").value = '';		 
		 document.getElementById("frmRimbSanz:txtSocieta").value = '';
		 document.getElementById("frmRimbSanz:txtStruttura").disabled = true;
	}
}
