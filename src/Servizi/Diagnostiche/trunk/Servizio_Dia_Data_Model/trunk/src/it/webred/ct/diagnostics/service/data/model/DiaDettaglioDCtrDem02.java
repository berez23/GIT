...
/**
 * The persistent class for the DIA_DETTAGLIO_D_CTR_DEM02 database table.
 * 
 */
@Entity
@Table(name="DIA_DETTAGLIO_D_CTR_DEM02")
public class DiaDettaglioDCtrDem02 extends it.webred.ct.diagnostics.service.data.SuperDia implements Serializable {
