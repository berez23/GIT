...
/**
 * The persistent class for the DOCFA_DIAGNOSTICHE_NORES database table.
 * 
 */
@Entity
@Table(name="DOCFA_DIAGNOSTICHE_NORES")
public class DocfaNonResidenziale implements Serializable {
