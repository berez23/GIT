 ...
 *         Comments
 */
public class VusLogic extends EscLogic
{
	private String appoggioDataSource;

	public VusLogic(EnvUtente eu)
	{
		super(eu);
	...
	public final static String LISTA_VUS = "LISTA_VUS@VusLogic";
	public final static String VUS = "VUS@VusLogic";
	public final static String VUS_CATA = "VUS_CATA@VusLogic";
	...
	private final static String SQL_SELECT_LISTA =
								...
								"FROM vus_utenze_acqua " +
								"WHERE 1= ? ";

	private final static String SQL_SELECT_COUNT_LISTA =
								"SELECT COUNT(*) conteggio FROM vus_utenze_acqua WHERE 1=? ";

	public Hashtable mCaricareLista(Vector listaPar, VusFinder finder)
		throws Exception
	{
	...
	public Hashtable mCaricareDettaglio(String chiave) throws Exception
	{
		...
		try
		{
			...
			String sql ="select  distinct ute.cod_servizio,ute.COD_FISCALE,ute.PART_IVA, " +
						...
						"from vus_utenze_acqua ute, vus_categorie_acqua cate,vus_catasto_acqua cata " +
