 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SoggettoFascicolo extends EscObject implements Serializable{
	...
	private List presenzeDB;
	private Clob xmlDb;
	private String codEnte;
	
	
	
	public SoggettoFascicolo(){
		codSoggetto = "";
		regola = "";
		dataCaricamento = "";
		comune = "";
	...
	public List getPresenzeDB() {
		return presenzeDB;
	}
	public void setPresenzeDB(List presenzeDB) {
		this.presenzeDB = presenzeDB;
	}
	public Clob getXmlDb() {
		return xmlDb;
	}
	public void setXmlDb(Clob xmlDb) {
		this.xmlDb = xmlDb;
	}
