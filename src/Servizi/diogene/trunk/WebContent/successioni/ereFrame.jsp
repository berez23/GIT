...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/successioni/ereDetail.jsp" noresize class="frame">
	<%
	} 
else if(ST.equals("4")){%>
<frameset rows="*" border="0">
<frame name="bodyPage" src="<%= request.getContextPath() %>/successioni/erePart.jsp" noresize class="frame">
<%}
else 
{	
if(ST.equals("1")){%>
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/successioni/ereList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/successioni/ereDetail.jsp" noresize class="frame">
