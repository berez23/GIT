...
<%  
	...
	java.util.Vector vlista=(java.util.Vector)sessione.getAttribute("LISTA_DEFUNTI_EREDITA"); 
	Defunto def = (Defunto)sessione.getAttribute("DEFUNTO");
	
	DefuntoFinder finder = null;
	if (sessione.getAttribute("FINDER15")!= null){
		finder = (DefuntoFinder)sessione.getAttribute("FINDER15"); 
	}else 
		finder = new DefuntoFinder();
...
<html>
<head>
<title>Successioni Defunti - Particolare Dettaglio</title>
...
wait();
	...
	progressivoErede = document.all("PROGRESSIVO_EREDE_"+indice).value;
...
<div align="center" class="extWinTDTitle"><span class="extWinTXTTitle">
	<%=def.getCognome()%> <%=def.getNome()%></span>
</div>
...
<tr>
	...
	<tr> 
		<td colspan=4 class="extWinTDTitle"><span class="extWinTXTTitle">Dati Oggetto</span></td> 
