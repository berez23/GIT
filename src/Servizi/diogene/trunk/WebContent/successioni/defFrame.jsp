...
<html>
<head>
<title>Successioni - Defunti</title>
...
<%if(ST.equals("33") || ST.equals("101")){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/successioni/defDetail.jsp" noresize class="frame">
	<%
	}
else if(ST.equals("4") ){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/successioni/defPart.jsp" noresize class="frame">
	<%
	}
else if(ST.equals("1")){%>
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/successioni/defList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/successioni/defDetail.jsp" noresize class="frame">
