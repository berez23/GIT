...
<html>
<head>
<title>Successioni - Oggetti</title>
...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/successioni/oggDetail.jsp" noresize class="frame">
	<%
	} 
else if(ST.equals("4") ){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/successioni/oggPart.jsp" noresize class="frame">
	<%
	}
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/successioni/oggList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/successioni/oggDetail.jsp" noresize class="frame">
	<%}%>
