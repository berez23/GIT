...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/AnagrafeAnagrafe?ST=1&UC=8','1')">Anagrafe</a>
	<center><img src="../ewg/images/anagrafe.jpg"></img></center>
