<%@ page language="java"
	import="java.util.ArrayList,java.util.Iterator,it.escsolution.escwebgis.docfa.bean.*,it.escsolution.escwebgis.docfa.logic.*,it.escsolution.escwebgis.catasto.logic.*,it.escsolution.escwebgis.indagineCivico.logic.*,it.escsolution.escwebgis.indagineCivico.bean.*"%>
<!DOCTYPE HTML PUBLIC "-//w3c//dtd html 4.0 transitional//en">


<%
DatiDocfa datiDocfa = (DatiDocfa)request.getAttribute(IndagineCivicoLogic.DOCFA);
java.util.ArrayList listaDocfaDatiCensuari =null;
if (request.getAttribute(DocfaLogic.LISTA_DETTAGLIO_DOCFA_SOLOREQUEST_DATI_CENSUARI) != null)
   listaDocfaDatiCensuari = (java.util.ArrayList) request.getAttribute(DocfaLogic.LISTA_DETTAGLIO_DOCFA_SOLOREQUEST_DATI_CENSUARI);
Integer numPlan =null;
if(request.getAttribute(DocfaLogic.NUMERO_DI_PLANIMETRIE)!= null)
   numPlan = (Integer)request.getAttribute(DocfaLogic.NUMERO_DI_PLANIMETRIE);
...
<!--  docfa -->	
				...
				<table class="viewExtTable" style="width: 100%;">
					<tr>
						<td colspan="4" class="TDmainLabel"
							...
							<a href="<%= EscServlet.URL_PATH%>/DocfaImmaginiPlanimetrie?protocollo=<%=datiDocfa.getProtocollo()%>&fornitura=<%=datiDocfa.getFornitura()%>&idFunz=2">
	...
	<br>
	<span class="TXTmainLabel">Dettaglio superfici per vano (DOCFA)</span>
		<table align=center class="extWinTable" style="width: 100%">
            ...
            if (listaDocfaDatiCensuari != null)  {
...
<br>
		...
		<table width="100%" class="extWinTable" cellpadding="0" cellspacing="0">
			...
			<% if (request.getAttribute(DocfaLogic.LISTA_DETTAGLIO_DOCFA_SOLOREQUEST_340) != null){
	...
	%>
			...
			<br/>
			<span class="extWinTXTTitle">Planimetrie comma 340</span>
