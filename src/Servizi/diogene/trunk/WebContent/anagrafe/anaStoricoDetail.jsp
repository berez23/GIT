...
<%   java.util.Vector vlista=(java.util.Vector)sessione.getAttribute(it.escsolution.escwebgis.anagrafe.logic.AnagrafeStoricoAnagrafeLogic.ANAGRAFE_STORICO); %>
...
<%  it.escsolution.escwebgis.anagrafe.bean.AnagrafeStoricoFinder finder = null;
	...
	if (sessione.getAttribute(it.escsolution.escwebgis.anagrafe.servlet.AnagrafeStoricoAnagrafeServlet.NOMEFINDER) !=null){
		if (((Object)sessione.getAttribute(it.escsolution.escwebgis.anagrafe.servlet.AnagrafeStoricoAnagrafeServlet.NOMEFINDER)).getClass() == new AnagrafeStoricoFinder().getClass()){
			finder = (it.escsolution.escwebgis.anagrafe.bean.AnagrafeStoricoFinder)sessione.getAttribute(it.escsolution.escwebgis.anagrafe.servlet.AnagrafeStoricoAnagrafeServlet.NOMEFINDER);
			}
...
<html>
<head>
<title>Anagrafe Storico 2006 - Dettaglio Soggetto</title>
...
{
	window.open('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/anagrafe/dettaglioFamiglia.jsp?pos='+posList,'dettaglioFamiglia','toolbar=no,scrollbars=auto,resizable=yes,width=400,height=300');
}
</script>
<body onload="mettiST()">
...
<div align="center" class="extWinTDTitle"><span class="extWinTXTTitle">
	Dettaglio Storico Anagrafe Soggetto</span> 
</div>
...
<br/>          
   <table width="100%" class="extWinTable" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="extWinTDTitle"><span class="extWinTXTTitle">CODICE FISCALE<span class="extWinTXTTitle"></td>
