...
<%java.lang.String origine = (java.lang.String)sessione.getAttribute("origine");%>
...
<%if(ST.equals("33") || ST.equals("101")|| ST.equals("102")|| ST.equals("103")){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/anagrafe/anaDwhDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
	...
	%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/anagrafe/anaDwhPopList.jsp" noresize class="frame">
	<%	} else {%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/anagrafe/anaDwhList.jsp" noresize class="frame">
	<%	}%>
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/anagrafe/anaDwhDetail.jsp" noresize class="frame">
	<%}%>
