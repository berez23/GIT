...
<html>
<head>
<title>Esatri - Riversamenti</title>
...
<%if(ST.equals("33")){%>
	...
	<frame name="bodyPage" src="<%= request.getContextPath() %>/esatri/rivDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/esatri/rivList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/esatri/rivDetail.jsp" noresize class="frame">
	<%}%>
