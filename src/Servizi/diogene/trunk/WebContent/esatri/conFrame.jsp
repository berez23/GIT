...
<%if(ST.equals("33")){%>
	...
	<frame name="bodyPage" src="<%= request.getContextPath() %>/esatri/conDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/esatri/conList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/esatri/conDetail.jsp" noresize class="frame">
	<%}%>
