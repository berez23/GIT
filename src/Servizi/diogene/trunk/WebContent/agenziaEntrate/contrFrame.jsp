...
<%if(ST.equals("33")){%>
	...
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/agenziaEntrate/contrDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/agenziaEntrate/contrList.jsp" noresize class="frame">
	<%}else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/agenziaEntrate/contrDetail.jsp" noresize class="frame">
	<%} else {%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/agenziaEntrate/contrDetail.jsp" noresize class="frame">
