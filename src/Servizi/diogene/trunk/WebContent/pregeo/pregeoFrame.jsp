...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/pregeo/pregeoDetail.jsp" noresize class="frame">
	<%
	} else {
if(ST.equals("1")){%>
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/pregeo/pregeoList.jsp" noresize class="frame">
	<%}else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/pregeo/pregeoDetail.jsp" noresize class="frame">
	<%} else {%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/pregeo/pregeoDetail.jsp" noresize class="frame">
	<%}%>
