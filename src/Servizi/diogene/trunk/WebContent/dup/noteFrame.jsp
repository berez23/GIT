...
<%if(ST.equals("33") || ST.equals("101") || ST.equals("102") || ST.equals("103") || ST.equals("104")|| ST.equals("105")){%>

<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/dup/noteDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/dup/noteList.jsp" noresize class="frame">
	<%}else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/dup/noteDetail.jsp" noresize class="frame">
	<%} else {%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/dup/noteDetail.jsp" noresize class="frame">
	<%}%>
