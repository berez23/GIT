...
<%if(ST.equals("33") || ST.equals("103") || ST.equals("101")|| ST.equals("102")){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/fornitureGas/fornitureGasDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fornitureGas/fornitureGasList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fornitureGas/fornitureGasDetail.jsp" noresize class="frame">
	<%}%>
