...
<html>
<head>
<title>Catasto Intestatari</title>
...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/catasto/intGiuDetail.jsp" noresize class="frame">
	<%
	} 
else if(ST.equals("4") ){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/catasto/intGiuPart.jsp" noresize class="frame">
	<%
	}
else 
{	
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/catasto/intGiuList.jsp" noresize class="frame">
	<%}else if(ST.equals("3") || ST.equals("5")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/catasto/intGiuDetail.jsp" noresize class="frame">
	<%}%>
