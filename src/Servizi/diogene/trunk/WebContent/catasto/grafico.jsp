...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/CatastoGrafico?ST=1&UC=1','1')">Catasto Grafico</a>
	<center><img src="../ewg/images/grafico.jpg"></img></center>
