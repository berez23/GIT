...
<% it.escsolution.escwebgis.catasto.bean.IntestatarioF intF=(it.escsolution.escwebgis.catasto.bean.IntestatarioF)sessione.getAttribute("INTESTATARIOF"); %>
...
<html>
<head>
<title>Catasto Intestatari Fisici - Particelle</title>
...
<div align="center" class="extWinTDTitle"><span class="extWinTXTTitle">
	<%=intF.getCognome()%> <%=intF.getNome()%></span>
</div>
	...
	<tr>
		...
		<td width="50%"  valign="top" style="background-color: #FFFFFF;">
			...
			<table width="100%" class="extWinTable" cellpadding="0" cellspacing="0">
				...
				<tr> 
					<td colspan=5 class="extWinTDTitle"><span class="extWinTXTTitle">Particelle Terreni</span></td> 
				</tr>
	...
	<% contatore++;progressivoRecord ++;} %>
		...
		<td width="50%"  valign="top" style="background-color: #FFFFFF;">
			...
			<table width="100%" class="extWinTable" cellpadding="0" cellspacing="0">
				...
				<tr> 
					<td colspan=6 class="extWinTDTitle"><span class="extWinTXTTitle">Particelle Fabbricati</span></td>
				</tr>
