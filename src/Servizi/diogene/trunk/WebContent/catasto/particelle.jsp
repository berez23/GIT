...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/CatastoTerreni?ST=1&UC=2','1')">Catasto Terreni</a>
	<center><img src="../ewg/images/terreni.jpg"></img></center>
