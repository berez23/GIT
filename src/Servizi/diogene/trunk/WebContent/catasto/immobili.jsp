...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/CatastoImmobili?ST=1&UC=1','1')">Catasto Fabbricati</a>
	<center><img src="../ewg/images/edificio.jpg"></img></center>
