...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/CatastoIntestatariG?ST=1&UC=4','1')">Persone Giuridiche</a>
	<center><img src="../ewg/images/personegiuridiche.jpg"></img></center>
