   ...
   for(i=0; i<pra.length; i++){
    ...
    if(pra[i][1]>0){
		if(pra[i][2]=="c"){
			   ...
			   lev+='<img style="cursor: pointer;" onclick="javascript:apri(\''+pra[i][3]+'\',\''+img_name+'\',\''+id_pra+'\','+i+');report(\''+pra[i][9]+'\')" src="'+imm0.src+'" name=\"'+img_name+'\"  border="0">';
			   lev+='&nbsp;&nbsp;&nbsp;<a href="javascript:apri(\''+pra[i][3]+'\',\''+img_name+'\',\''+id_pra+'\','+i+')" onFocus="this.blur()">';
     	...
     	if (pra[i][2]=="1"){
		       ...
		       lev+='<div id=\"'+id_pra+'\" style="position:absolute;visibility:'+nn+'; top:'+pra[i][4]+';left:'+(left_pra+pra[i][1])+'; height:20;width:'+width_pra+';">';
			   lev+='<input value="off" id="img'+i.toString(10)+'" type="image" src="images/'+pra[i][8]+'" border="0" onClick="javascript:aspm(\''+pra[i][3]+'\',\''+pra[i][0]+'\','+pra[i][7]+')">&nbsp;';
	  ...
	  if (pra[i][2]=="11"){
		  ...
		  lev+='<a href="javascript:quale('+i+');apri(\''+pra[i][3]+'\',\''+img_name+'\',\''+id_pra+'\','+i+');report(\''+pra[i][9]+'\')" style="text-decoration:none;"  ><font color=\"'+fc_pra+'\" face=\"'+ff_pra+'\">'+pra[i][0]+'</font>';
		  lev+='</a></div>'; 
			}
}
  if(isie4)
