...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/AnagrafeFamiglia?ST=1&UC=9','1')">Famiglia</a>
	<center><img src="../ewg/images/famiglia.jpg"></img></center>
