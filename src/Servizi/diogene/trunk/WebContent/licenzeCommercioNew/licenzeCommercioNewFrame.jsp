...
<html>
<head>
<title>Licenze di Commercio</title>
...
<%if(ST.equals("33")|| ST.equals("103")|| ST.equals("102")){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/licenzeCommercioNew/licenzeCommercioNewDetail.jsp" noresize class="frame">
	<%
	} 
else if (ST.equals("101")){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/licenzeCommercioNew/licenzeCommercioNewList.jsp" noresize class="frame">
<%}
else 
{	 
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/licenzeCommercioNew/licenzeCommercioNewList.jsp" noresize class="frame">
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/licenzeCommercioNew/licenzeCommercioNewDetail.jsp" noresize class="frame">
	<%}%>
