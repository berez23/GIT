...
<html>
<head>
<title>Informazioni Civico Ecografico</title>
<LINK rel="stylesheet"
...
<body>
		...
		<table width="100%" class="extWinTable" cellpadding="0" cellspacing="0">
			<tr>
				<td class="extWinTDData" ><span class="extWinTXTData">Informazioni Civico Ecografico</span>
							
							<div >
								 <br/>
						       <a href="javascript:openView('<%=request.getContextPath()%>/EcograficoCivici?DATASOURCE=jdbc/dbIntegrato&ST=3&UC=117&OGGETTO_SEL=<%=pk%>&LAYER=<%=layerName%>')">Ecografico Civici</a>
						         <br/>
