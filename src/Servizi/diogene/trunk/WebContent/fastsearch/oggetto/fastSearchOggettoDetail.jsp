...
<%  
	...
	OggettoTotaleBean ogg = (OggettoTotaleBean) session.getAttribute("oggIndiceUnico");
...
<table width="100%" class="extWinTable" cellpadding="0" cellspacing="0">
	<tr>
	 <td class="extWinTDTitle" width="50%">
 			...
 			<%
 				String descr1 = "F.: "+ ogg.getFoglio() + " P.: " + ogg.getParticella()+ " S.: " + ogg.getSub() ;
 			...
 			<span class="extWinTXTData">
 			  <% if (ib != null) { %>
		 			  <span class="TXTmainLabel">
 					 	<img src="../../images/<%=img%>"  
 							 onclick="eseguiCrossLinkInd('<%=ib.getIdUnico()%>', '<%=ib.getFonteId()%>', 4, '<%=descr1 %>')"
