...
<% 
 if(ST.equals("3") ){%>
	...
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fastsearch/via/fastSearchViaDetail.jsp" noresize class="frame">
	<%
 } 
 else {
	if(ST.equals("1")){%>
...
<frameset rows="0,30,*,30" border="0">
	...
	<%}else if(ST.equals("2") ) { %>		
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fastsearch/via/fastSearchViaList.jsp" noresize class="frame">	
	<%} else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fastsearch/via/fastSearchViaDetail.jsp" noresize class="frame">
	<%}%>
	<%if(ST.equals("2")){%>
