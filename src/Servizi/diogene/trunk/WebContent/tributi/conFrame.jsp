...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/tributi/conDetail.jsp" noresize class="frame">
<%
} 
else 
{
...
%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/tributi/conList.jsp" noresize class="frame">
	<%}else if(ST.equals("3") || ST.equals("5")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/tributi/conDetail.jsp" noresize class="frame">
	<%} else if(ST.equals("4")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/tributi/conPart.jsp" noresize class="frame">
	<%}%>
