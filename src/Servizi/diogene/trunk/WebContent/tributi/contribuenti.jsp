...
<html>
	...
	<body>
		<a href="javascript:apri('<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/TributiContribuenti?ST=1&UC=5','1')">Contribuenti</a>
	<center><img src="../ewg/images/casa.jpg"></img></center>
