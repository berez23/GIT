...
<html>
	<head>
		<title>Storico Concessioni</title>
...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/concessioni/storicoConcessioniDetail.jsp" noresize class="frame">
	<%
	}
else if (ST.equals("101")|| ST.equals("102")|| ST.equals("103")|| ST.equals("104")|| ST.equals("105") ){%>
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= request.getContextPath() %>/concessioni/storicoConcessioniList.jsp" noresize class="frame">
<%}
else 
{
...
<frameset rows="0,*" border="0">
	...
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/concessioni/storicoConcessioniDetail.jsp"  noresize class="frame">
	</frameset>
<%}else{%>
	<%if(ST.equals("1")){%>
	...
	<%}%>
		...
		<%}else if(ST.equals("2")){%>
			<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/concessioni/storicoConcessioniList.jsp" noresize class="frame">
		<%} else if(ST.equals("3")){%>
			<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/concessioni/storicoConcessioniDetail.jsp" noresize class="frame">
		<%}%>
