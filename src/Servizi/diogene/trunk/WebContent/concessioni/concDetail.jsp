...
<%   Concessione con = (Concessione) sessione.getAttribute(it.escsolution.escwebgis.concessioni.logic.ConcessioneLogic.CONCESSIONE); %>
<%   
...
<%  ConcessioneFinder finder = null;
	...
	if (sessione.getAttribute(it.escsolution.escwebgis.concessioni.servlet.ConcessioneServlet.NOMEFINDER) !=null){
		if (((Object)sessione.getAttribute(it.escsolution.escwebgis.concessioni.servlet.ConcessioneServlet.NOMEFINDER)).getClass() == new ConcessioneFinder().getClass()){
			finder = (ConcessioneFinder)sessione.getAttribute(it.escsolution.escwebgis.concessioni.servlet.ConcessioneServlet.NOMEFINDER);
			}
...
<html>
<head>
<title>Concessioni 1988-1996  Dettaglio</title>
...
<form name="mainform" action="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/Concessione" target="_parent">

<div align="center" class="extWinTDTitle">
	<span class="extWinTXTTitle">&nbsp;<%=funzionalita%>:&nbsp;Dettaglio Concessione</span>
</div>
&nbsp;
...
<% }%>
		...
		<input type='hidden' name="UC" value="41">
