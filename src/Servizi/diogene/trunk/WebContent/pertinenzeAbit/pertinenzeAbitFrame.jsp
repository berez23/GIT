...
<html>
<head>
<title>Pertinenze Abitativo</title>
...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/pertinenzeAbit/pertinenzeAbitDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
	...
	<%}else if(ST.equals("2")){%>
		<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/pertinenzeAbit/pertinenzeAbitList.jsp" noresize class="frame">
	<%} else {%>
		<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/pertinenzeAbit/pertinenzeAbitDetail.jsp" noresize class="frame">
	<%}%>
