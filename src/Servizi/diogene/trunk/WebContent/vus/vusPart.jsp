...
<%   VusCatasto vus = (VusCatasto) sessione.getAttribute(VusLogic.VUS_CATA); %>
<%  
...
<html>
<head>
<title>Utenti Forniture Idriche - Dettaglio Dati Catastali</title>
...
<div align="center" class="extWinTDTitle">
	<span class="extWinTXTTitle">Dettaglio Dato Catastale Utenza Acqua</span>
</div>
&nbsp;
