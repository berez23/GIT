...
<%   VusGas vus = (VusGas) sessione.getAttribute(VusGasLogic.VUS_GAS); %>
<%   
...
<html>
<head>
<title>Utenti VUS Gas - Dettaglio</title>
...
function vaiPart(chiave){
	document.mainform.action="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/VusGas";
...
<div align="center" class="extWinTDTitle">
	<span class="extWinTXTTitle">Dettaglio Utenti VUS Gas</span>
</div>
&nbsp;
