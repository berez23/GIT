...
<% java.util.Vector vlista = (java.util.Vector) sessione.getAttribute(VusGasLogic.LISTA_VUS_GAS); %>
...
<html>
<head>
<title>Lista Utenti Forniture Gas - Lista</title>
...
<% if (vlista.size() > 0){
	VusGas vus = (VusGas) vlista.get(0);%>
function vaiPrimo(){
...
<form name="mainform" action="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/VusGas" target="_parent" >
 
<div align="center" class="extWinTDTitle"><span class="extWinTXTTitle">
	Lista Utenti Forniture Gas</span>
</div>
