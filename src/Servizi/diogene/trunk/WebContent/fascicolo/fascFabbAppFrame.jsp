...
<html>
	<head>
		<title>Fascicolo Fabbricato</title>
	...
	<%if("3".equals(ST) || "4".equals(ST)){%>
		<frameset rows="0,*" border="0">
			...
			<%if(ST.equals("3")){%>
			<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fascicolo/fascFabbAppSearch.jsp" noresize class="frame">
			<%}else if(ST.equals("4")){%>
			<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/fascicolo/fascFabbAppDetail.jsp" noresize class="frame">
			<%}%>
		</frameset>
	<%}else{%>
		<%if(ST.equals("1")){%>
