...
<div align="center" class="extWinTDTitle"><span class="extWinTXTTitle">
	<%=funzionalita%>&nbsp;:&nbsp;<%=titolo%>&nbsp;</span><br/>
	
</div>
<br/>

<div align="center"><span class="extWinTXTTitle">&nbsp;Codice Fiscale:&nbsp;<%=sessione.getAttribute("OGGETTO_SEL_CF")%></span></div><br/>

<form name="mainform" target="_parent" action=<%=Tema.getServletMapping(uc)%> onSubmit="return controlloParametri();" method="post">
             ...
             <table class="viewExtTable" >			 	
			 	...
			 	<% } else {%>
			 		<td class="TDviewTextBox" style="width:50;">
				 		<%if(el.getTipo().equals("PWD")){ %>
				 			<input type="password" name="VALORE_<%=contatore%>" id="<%=el.getAttributeName()%>" value="" style="width:135;" class="TXTviewTextBox">
				 		<%}else{ %>
...
<tr>
	<td align="center">				
		...
		<input type='hidden' name="OGGETTO_SEL_FGL" value="<%=sessione.getAttribute("OGGETTO_SEL_FOGLIO")%>">
		<input type='hidden' name="OGGETTO_SEL_PAR" value="<%=sessione.getAttribute("OGGETTO_SEL_PARTICELLA")%>">
