...
<html>
<head>
<title>DIAGNOSTICHE DOCFA</title>
...
<%}%>
	...
	<%if(ST.equals("1")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/diagnostiche/diagnosticheTarsuTotList.jsp" noresize class="frame">
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/diagnostiche/diagnosticheTarsuPropResList.jsp" noresize class="frame">
	<%}%>
	<%if(ST.equals("2")){%>
