...
<html>
<head>
<title>DIAGNOSTICHE DOCFA NO RES</title>
...
<%}%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/diagnostiche/diagnosticheDocfaNoResList.jsp" noresize class="frame">
	<%}%>
	<%if(ST.equals("2")){%>
