...
%> 
<% java.util.Vector vlistaCond=(java.util.Vector)sessione.getAttribute(DiagnosticheDocfaLogic.LISTA_DIAGNOSTICHE); %>
<% java.util.Vector vlistaCat=(java.util.Vector)sessione.getAttribute(DiagnosticheDocfaLogic.LISTA_CATEGORIE); %>
<% DiagnosticheDocfaFinder finder = (DiagnosticheDocfaFinder)sessione.getAttribute("FINDER102"); %>
<%int js_back = 1;
	if (sessione.getAttribute("BACK_JS_COUNT")!= null)
		js_back = ((Integer)sessione.getAttribute("BACK_JS_COUNT")).intValue();%>  

<%@page import="it.escsolution.escwebgis.diagnostiche.bean.DiagnosticheDocfaFinder"%>
<%@page import="it.escsolution.escwebgis.diagnostiche.bean.DiagnosticheDocfa"%>
<%@page import="it.escsolution.escwebgis.diagnostiche.logic.DiagnosticheDocfaLogic"%>
<html>
<head>
<title>Diagnostiche Docfa Residenziali</title>
...
DiagnosticheDocfa sFornit=(DiagnosticheDocfa)vlistaCond.get(0);%>
function vaiPrimo(){
...
<form name="mainform" action="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/DiagnosticheDocfa" target="_parent" >
 
<div align="center" class="extWinTDTitle"><span class="extWinTXTTitle">
	Lista Diagnostiche Docfa Residenziali</span>
</div>
	
		
<% String smsErrore = (String)sessione.getAttribute(DiagnosticheDocfaLogic.SMS_DIAGNOSTICHE_RES);
if (smsErrore!= null){
	sessione.removeAttribute(DiagnosticheDocfaLogic.SMS_DIAGNOSTICHE_RES);
%>
<br>
...
&nbsp;
  ...
  <% while (en.hasMoreElements()) {
	  dd = (DiagnosticheDocfa)en.nextElement();%>
	<tr>
...
<input type='hidden' name="UC" value="102">
