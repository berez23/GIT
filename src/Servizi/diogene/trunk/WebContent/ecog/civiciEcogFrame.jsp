...
<%   java.lang.String ST = (java.lang.String)sessione.getAttribute("ST");
	System.out.println("civiciEcogFrame - ST="+ ST);
...
<frameset rows="*" border="0">
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/ecog/civiciEcogDetail.jsp" noresize class="frame">
	<%
	} 
else 
{	
...
<%}else{%>
	...
	<%}else if(ST.equals("2")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/ecog/civiciEcogList.jsp" noresize class="frame">
	<%}else if(ST.equals("3")){%>
	<frame name="bodyPage" src="<%= it.escsolution.escwebgis.common.EscServlet.URL_PATH %>/ecog/civiciEcogDetail.jsp" noresize class="frame">
	<%} else{%>
	<%}%>
