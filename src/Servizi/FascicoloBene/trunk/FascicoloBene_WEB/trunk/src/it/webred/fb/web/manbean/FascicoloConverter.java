...
@FacesConverter("fascicoloConverter")
@ViewScoped
public class FascicoloConverter extends FascicoloBeneBaseBean implements Converter {
	    ...
	    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
	    	...
	    	if(value != null && !"null".equalsIgnoreCase(value)  && value.trim().length() > 0) {
	    		...
	    		if(corrente==null || !value.equals(corrente.getCodice())){
					...
					b.setRicercaCatasto(false);
		    		b.setDesFascicolo(value);
		    		//corrente = beneService.getFascicoloByCod(b);
	    		}
	    		return corrente;
