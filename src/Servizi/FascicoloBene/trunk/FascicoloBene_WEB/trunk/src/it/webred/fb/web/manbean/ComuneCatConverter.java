...
@FacesConverter("comuneCatConverter")
@ViewScoped
public class ComuneCatConverter extends FascicoloBeneBaseBean implements Converter {
	    ...
	    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
	    	...
	    	if(value != null && !"null".equalsIgnoreCase(value)  && value.trim().length() > 0) {
	    		...
	    		if(corrente==null || !value.equals(corrente.getCodice())){
					...
					b.setRicercaCatasto(true);
		    		b.getComuneCat().setCodice(value);
