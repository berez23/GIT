...
@FacesConverter("comuneIndConverter")
@ViewScoped
public class ComuneIndConverter extends FascicoloBeneBaseBean implements Converter {
	    ...
	    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
	    	...
	    	if(value != null && !"null".equalsIgnoreCase(value) && value.trim().length() > 0) {
	    		...
	    		if(corrente==null || !value.equals(corrente.getCodice())){
					...
					b.setRicercaIndirizzo(true);
		    		b.getComuneInd().setCodice(value);
		    		corrente = beneService.getComuneByCod(b);
	    		}
	    		return corrente;
