package it.webred.cet.service.gestprep.web;
...
public class GestPrepBaseBean implements Serializable  {

	private static ResourceBundle bundle;
	
	static {
		bundle = ResourceBundle
				.getBundle("it.webred.cet.service.gestprep.web.resources.messages");
	}

	private static Logger logger = Logger.getLogger("gestprep.log");
