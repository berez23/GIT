...
/**
 * The persistent class for the S_SP_AREA_PART database table.
 * 
 */
@Entity
@Table(name="S_SP_AREA_PART")
public class SSpAreaPart implements Serializable{
	...
	@Column(name="ID_SP_AREA_PART")
	private Long idSpAreaPart;
	...
	public Long getIdSpAreaPart() {
		return idSpAreaPart;
	}

	public void setIdSpAreaPart(Long idSpAreaPart) {
		this.idSpAreaPart = idSpAreaPart;
	}
