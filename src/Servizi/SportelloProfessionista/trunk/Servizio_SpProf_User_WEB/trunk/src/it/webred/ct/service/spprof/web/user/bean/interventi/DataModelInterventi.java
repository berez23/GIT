...
public class DataModelInterventi extends SerializableDataModel implements Serializable {
	...
	public void walk(FacesContext context, DataVisitor visitor, Range range,
		...
		if (detached) { // Is this serialized model
			...
			for (SSpIntervento item : dataProvider.getInterventiByRange(firstRow,
					numberOfRows)) {

				System.out.println("Item [" + item.getIdSpIntervento() + "]");
				wrappedKeys.add("" + item.getIdSpIntervento());
				wrappedData.put("" + item.getIdSpIntervento(), item);
				visitor.process(context, "" + item.getIdSpIntervento(), argument);
			}
		}
	}
	...
	public int getRowCount() {
		rowCount = new Integer(dataProvider.getInterventiCount().intValue());
