package it.webred.ct.service.spprof.web.user;
...
private static ResourceBundle bundle;
	...
	static {
		bundle = ResourceBundle
				.getBundle("it.webred.ct.service.spprof.web.user.resources.messages");
	}
	
	
	protected static Logger logger = Logger.getLogger("spprof.log");
