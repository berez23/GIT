...
public class DataModelCivici extends SerializableDataModel implements Serializable {
	...
	public void walk(FacesContext context, DataVisitor visitor, Range range,
		...
		if (detached) { // Is this serialized model
			...
			for (CivicoDTO item : dataProvider.getViaByRange(firstRow,
					numberOfRows)) {

				System.out.println("Item [" + item.getPkidCivi() + "]");
				wrappedKeys.add("" + item.getPkidCivi());
				wrappedData.put("" + item.getPkidCivi(), item);
				visitor.process(context, "" + item.getPkidCivi(), argument);
			}
		}
	}
	...
	public int getRowCount() {
		rowCount = new Integer(dataProvider.getViaCount().intValue());
