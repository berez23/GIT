...
public class DataModelParticelleByCivico extends SerializableDataModel implements Serializable {
	...
	public void walk(FacesContext context, DataVisitor visitor, Range range,
		...
		if (detached) { // Is this serialized model
			...
			String fogli = "";
			String particelle = "";
			for (ParticellaDTO item : dataProvider.getParticelleByCivicoRange(firstRow,
					numberOfRows)) {
	...
	public int getRowCount() {
		rowCount = new Integer(dataProvider.getParticelleByCivicoCount().intValue());
