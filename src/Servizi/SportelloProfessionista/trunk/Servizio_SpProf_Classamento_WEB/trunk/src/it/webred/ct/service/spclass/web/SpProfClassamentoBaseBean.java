package it.webred.ct.service.spclass.web;
...
public class SpProfClassamentoBaseBean implements Serializable {
	...
	static {
		bundle = ResourceBundle
				.getBundle("it.webred.ct.service.spclass.web.resources.messages");
	}
	...
	private void addMessage(String messageKey, FacesMessage.Severity severity,
		...
		FacesContext facesContext = FacesContext.getCurrentInstance();
		/*
		 * FacesContext facesContext = FacesContext.getCurrentInstance(); String
		 * txt = bundle.getString(messageKey);
		 */
