...
public class C340GestionePraticheServiceBean extends C340ServiceBaseBean implements C340GestionePraticheService {
	...
	/**
	 * Recupera dal database il nome descrittivo del Comune, il cui codice nazionale è passato a parametro.
	 * 
	 ...
	 * il cui codice identificativo è passato come parametro.
	 * 
	...
	/**
	 * Recupera dal database l'entity C340PratAllegato, il cui codice identificativo è passato come parametro
	 * 
