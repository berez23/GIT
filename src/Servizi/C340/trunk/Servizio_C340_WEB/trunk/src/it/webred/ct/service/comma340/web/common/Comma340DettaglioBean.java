...
public class Comma340DettaglioBean extends Comma340BaseBean {
	...
	public void initService() {
		...
		dettImmobile = new DettaglioC340ImmobileDTO();
	...
	public String apriDettaglio() {
		...
		try{
			...
			RicercaOggettoCatDTO ro = new RicercaOggettoCatDTO(codNazionale, selIdUiu);
			fillEnte(ro);  //Data-Routing
			dettImmobile = c340.getDettaglioC340Immobile(ro);
	...
	public void findFilePlanimetrie(List<PlanimetriaComma340DTO> planimC340_parziali){
		...
		String pathPlanimetrieC340 = super.getPathPlanimetrieC340();
