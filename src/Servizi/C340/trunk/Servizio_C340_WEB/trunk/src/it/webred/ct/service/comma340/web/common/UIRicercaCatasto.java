...
import it.webred.ct.service.comma340.web.catasto.CatastoDataProviderImpl;
...
public class UIRicercaCatasto {
	...
	private CatastoDataProviderImpl model;
	
	public CatastoDataProviderImpl getModel() {
		FacesContext context = FacesContext.getCurrentInstance();
		model = (CatastoDataProviderImpl)context.getApplication().getVariableResolver().resolveVariable(context,"catastoDataProviderImpl");
		return model;
	}
