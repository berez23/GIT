...
public class GestionePraticheBaseBean extends Comma340BaseBean{
	...
	private C340GestionePraticheService c340GestionePraticheService;
	...
	public C340GestionePraticheService getC340GestionePraticheService() {
		...
		//return (C340GestionePraticheService) this.getRemoteService("C340GestionePraticheServiceBean", "Servizio_C340");
	}
