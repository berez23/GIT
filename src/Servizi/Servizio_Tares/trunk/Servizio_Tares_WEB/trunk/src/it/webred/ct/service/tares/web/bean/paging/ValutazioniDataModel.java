...
public class ValutazioniDataModel extends SerializableDataModel implements Serializable {
	...
	private ValutazioniDataProvider dataProvider;
	...
	public void walk(FacesContext context, DataVisitor visitor, Range range,
		...
		if (detached) { // Is this serialized model
			...
			for (SetarElab item : dataProvider.doCercaElaborazioni(firstRow, numberOfRows)) {
	...
	public int getRowCount() {
		rowCount = new Integer(dataProvider.doCountElaborazioni().intValue());
	...
	public ValutazioniDataProvider getDataProvider() {
		return dataProvider;
	}

	public void setDataProvider(ValutazioniDataProvider dataProvider) {
