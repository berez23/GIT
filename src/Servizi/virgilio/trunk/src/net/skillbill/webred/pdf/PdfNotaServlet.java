...
public class PdfNotaServlet extends MuiBaseServlet {
	...
	protected void muiService(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			Paragraph titolo = new Paragraph("MUI - DETTAGLIO NOTA "+getProperty("numeroNotaTras",nota)+"/"+getProperty("annoNota",nota)+" valida dal "+getProperty("dataValiditaAtto",nota,true));
