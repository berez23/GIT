...
public class Info {
	...
	public static ArrayList<SelectItem> aylEsitiCollaudoOpz = new ArrayList<SelectItem>();
	...
	static{
		...
		aylEsitiCollaudoOpz.add(new SelectItem("", ""));
		aylEsitiCollaudoOpz.add(new SelectItem("1", "1: Classamento rettificato con accoglimento integrale della segnalazione;", "Classamento rettificato con accoglimento integrale della segnalazione;"));
		aylEsitiCollaudoOpz.add(new SelectItem("2", "2: Classamento rettificato in accoglimento parziale della segnalazione;", "Classamento rettificato in accoglimento parziale della segnalazione;"));
		aylEsitiCollaudoOpz.add(new SelectItem("3", "3: Incoerenze segnalate non influenti sul classamento;", "Incoerenze segnalate non influenti sul classamento;"));
		aylEsitiCollaudoOpz.add(new SelectItem("4", "4: Elementi segnalati insufficienti;","Elementi segnalati insufficienti;"));
		aylEsitiCollaudoOpz.add(new SelectItem("5", "5: Unita immobiliare segnalata movimentata da altro DOCFA;", "Unita immobiliare segnalata movimentata da altro DOCFA;"));
		aylEsitiCollaudoOpz.add(new SelectItem("7", "7: Unita immobiliare o fabbricato non presente nel documento DOCFA segnalato;", "Unita immobiliare o fabbricato non presente nel documento DOCFA segnalato;"));
		aylEsitiCollaudoOpz.add(new SelectItem("8", "8: Terna Protocollo-Anno-Comune non corrispondente ad un DOCFA Tecnico;", "Terna Protocollo-Anno-Comune non corrispondente ad un DOCFA Tecnico;"));
		aylEsitiCollaudoOpz.add(new SelectItem("9", "9: Terna Protocollo-Anno-Comune non esistente in banca dati;", "Terna Protocollo-Anno-Comune non esistente in banca dati;"));
