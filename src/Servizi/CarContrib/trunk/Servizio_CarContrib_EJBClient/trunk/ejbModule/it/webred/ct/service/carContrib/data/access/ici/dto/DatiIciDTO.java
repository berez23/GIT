package it.webred.ct.service.carContrib.data.access.ici.dto;
...
public class DatiIciDTO implements Serializable, java.util.Comparator<DatiIciDTO> {
	...
	public void valorizzaDatiDichiarazione(SitTIciOggetto ogg, List<VTIciSoggAll> listaSoggetti) {
		...
		this.flPoss3112="S".equalsIgnoreCase(ogg.getFlgPos3112())? "1" : "0";
		
		if (ogg.getPrcPoss()!=null)
			this.perPossessoF = StringUtility.DF.format(ogg.getPrcPoss());
		else
			this.perPossessoF = "-";
		this.mesiPossesso=ogg.getMesiPos();
		this.flAbitPrinc="S".equalsIgnoreCase(ogg.getFlgAbiPri3112())? "1" : "0";
		this.flAcq="S".equalsIgnoreCase(ogg.getFlgAcq())? "1" : "0";
		this.flCss="S".equalsIgnoreCase(ogg.getFlgCss())? "1" : "0";
