package it.webred.gdal.main;


import it.webred.gdal.natlib.NativeLoader;
...
/**
 * Le librerie native o dll vanno messe in una cartella configurata nella
 * variabile di ambiente 'Path' del OS.
 * Jboss durante il boot carica le classi e le libreire native ricercandole
 * in 'java.library.path' che equivale alla Path di Windows
 * 
 * Su Linux set LD_LIBRARY_PATH.
 * Su Windows set PATH.
 * 
 * @author webred
 *
...
public class ogr2ogr {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Vanno caricate librerie native DLL
         */
