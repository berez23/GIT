...
/**
 * MiVwTitolariSummary generated by hbm2java
 */

public class MiVwTitolariSummary  implements java.io.Serializable {
    ...
    /** default constructor */
    public MiVwTitolariSummary() {
    }

	/** minimal constructor */
    public MiVwTitolariSummary(long iid_fornitura) {
        this.iid_fornitura = iid_fornitura;
    }
    
    /** full constructor */
    public MiVwTitolariSummary(long iid_fornitura, long totale, long massimo, MiDupFornitura miDupFornitura) {
        this.iid_fornitura = iid_fornitura;
        this.totale = totale;
