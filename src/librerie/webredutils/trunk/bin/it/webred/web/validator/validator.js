<!-- Begin 
	...
	/**
	Sostituisce i codici Entit? con i caratteri accentati.
	@author Pietro Bartoccioni
	*/
	function replaceCharCode(theString)
	{
		theString=theString.replace("&#232;",String.fromCharCode(232));
		theString=theString.replace("&#242;",String.fromCharCode(242));
		theString=theString.replace("&#249;",String.fromCharCode(249));
		theString=theString.replace("&#236;",String.fromCharCode(236));
		theString=theString.replace("&#224;",String.fromCharCode(224));
		return theString;
	}
   /*$RCSfile: validator.js,v $ $Revision: 1.1 $ $Date: 2007/05/16 07:15:20 $ */
    /**
